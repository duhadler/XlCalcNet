...
public static void TestSincCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSincCplx" + "\"" + ">");
...
#region TestSincRealImag

public static void TestSincRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSincRealImag" + 
        "\"" + ">");
