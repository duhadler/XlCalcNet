...
k4 As Double, ByRef density As Double, ByRef LeftTail As Double, ByRef RightTail As Double)
    ...
    Sub cdis2(n As Double, X As Double, ByRef LeftTail As Double,
      ByRef RightTail As Double, ByRef density As Double)
        Dim j As Integer, i As Integer
        Dim sum(0 To 2) As Double
    ...
    Sub betadis_(a As Double, b As Double, Q As Double,
p As Double, ByRef LeftTail As Double, ByRef RightTail As Double,
    ...
    Sub BetaDisdemo()
        Dim a As Double, b As Double, q As Double, p As Double, L As Double, R As Double, density As Double, x As Double, NeedToConvert As Boolean, Temp As Double
        x = 0.48
        a = 1124.1
        b = 1114.1
        q = x
