...
T cyl_bessel_je(T v, T x) {
    ...
    return std::real(cyl_bessel_je(v, std::complex<T>(x)));
}
...
T cyl_bessel_ye(T v, T x) {
    ...
    return std::real(cyl_bessel_ye(v, std::complex<T>(x)));
}
...
T cyl_bessel_ie(T v, T x) {
    ...
    return std::real(cyl_bessel_ie(v, std::complex<T>(x)));
}
...
T cyl_bessel_ke(T v, T x) {
    ...
    return std::real(cyl_bessel_ke(v, std::complex<T>(x)));
}
...
T cyl_bessel_j(T v, T x) {
    ...
    std::complex<T> res = cyl_bessel_j(v, std::complex<T>(x));
...
T cyl_bessel_y(T v, T x) {
    ...
    std::complex<T> res = cyl_bessel_y(v, std::complex<T>(x));
    if (std::real(res) != std::real(res)) {
...
T cyl_bessel_k(T v, T z) {
    ...
    return std::real(cyl_bessel_k(v, std::complex<T>(z)));
}
