...
public static void TestCubeCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCubeCplx" + "\"" + ">");
...
#region TestCubeRealImag

public static void TestCubeRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCubeRealImag" + 
        "\"" + ">");
