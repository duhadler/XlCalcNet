...
def general_assignments():
    ...
    x = mpm.t(5.7)
    print('x = mpm.t(5.7):', x)
    x0 = mpm.t(2329456398453948563945639364827346)
    print('x0 = mpm.t(2329456398453948563945639364827346', x0)
    x1 = mpm.t("2329456398453948563945639364827346")
    print('x1 = mpm.t("2329456398453948563945639364827346"):', x1)
    x = mpm.t("5.5")
    print('x = mpm.t("5.5"):', x)
...
def functions_with_argument_conversion():
    ...
    z = mpm.exp(dec)
    print('z = mpm.exp(dec):', z)
#    frac = Fraction("-3/7")
#    print('frac = Fraction("-3/7:")', frac)
#    z = mpm.exp(frac)
#    print('z = mpm.exp(frac):', z)
    ...
    print('y = mpm.t(33):', y)
    z = mpm.pow(x, y)
    print('z = mpm.pow(x, y):        ', z)
    z = mpm.pow(5.5, 3.3)
    print('z = mpm.pow(5.5, 3.3):    ', z)
    z = mpm.pow("5.5", "3.3")
    print('z = mpm.pow("5.5", "3.3"):', z)
    z = mpm.pow(5, 3)
    print('z = mpm.pow(5, 3):', z)
...
#    xMat = mpm.Mat.Random(2,2)
#    print('xMat = mpm.Mat.Random(2,2): \n', xMat)
#
#    xcoeff = mpm.t(4.5)
#    print('xcoeff = mpm.t(4.5): ', xcoeff)
#
#    xMat[1,1] = xcoeff
