...
#region DemoAnyPolySolveCtx_3


public static void DemoSolveCubicReal()
{
    Console.WriteLine("Hello DemoSolveCubicReal: " + Ctx.name);

    var A = 1;
    var B = 0.441910366987445;
    var C = -0.672187472645632; 
    var D = -0.198008526383064; 

    var res = Ctx.cubic_equation(A, B, C, D);
    Console.WriteLine("x1: {0}, f(x1): {1}", res.Item1, Ctx.eval_cubic(res.Item1, A, B, C, D));
    Console.WriteLine("x2: {0}, f(x2): {1}", res.Item2, Ctx.eval_cubic(res.Item2, A, B, C, D));
    Console.WriteLine("x3: {0}, f(x3): {1}", res.Item3, Ctx.eval_cubic(res.Item3, A, B, C, D));
}

public static void DemoSolveCubicCplx()
{
    Console.WriteLine("Hello DemoSolveCubicCplx: " + Ctx.name);

    var A = dcplx.t(1, 0);
    var B = dcplx.t(0.206665783345176, 0.22633186596918);
    var C = dcplx.t(0.277883889299886, -0.767385695178652);
    var D = dcplx.t(0.373654914852069, -0.480864077812474);
