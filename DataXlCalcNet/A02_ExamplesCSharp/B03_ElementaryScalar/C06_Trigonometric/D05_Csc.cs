...
public static void TestCscCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCscCplx" + "\"" + ">");
...
#region TestCscRealImag

public static void TestCscRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCscRealImag" + 
        "\"" + ">");
