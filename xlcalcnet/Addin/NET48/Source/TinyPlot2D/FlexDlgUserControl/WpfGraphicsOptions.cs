...
namespace TinyPlot2DCtrl
{
    ...
    public class OutputDirectory : StringConverter
    {
        public static string[] GetItems()
        {
            return new string[]{
    ...
    public class BrushTexture2 : StringConverter
    {
        ...
        {
            string TexturePath = Plot2DCtrl._TexturePath;
    ...
    public partial class WpfGraphicsSettings
    {
        ...
        private void HandleImage(ref string MyImage, string MyValue)
        {
            ...
            if (MyImage != "None")
            {
                string ImageFullPath = Plot2DCtrl._TexturePath + @"\" + MyImage;
        ...
        [TypeConverter(typeof(RunAfterLoading)), Category("01. General"), Description("Determines whether the script is run immediately after loading"), DisplayName("C. Run After Loading")]
        public string RunAfterLoading { get; set; }




        //[TypeConverter(typeof(OutputDirectory)), Category("01. General"), Description("Output Directory "), DisplayName("D. Output Directory")]
        //public string OutputDir { get; set; }



        [Category("01. General"), Description("Title"), DisplayName("D. Title")]
        ...
        [TypeConverter(typeof(PlotStyle)), Category("01. General"), Description("Determines the plot style"), DisplayName("E. Plot Style")]
        public string PlotStyle { get; set; }



        [TypeConverter(typeof(OutputMode)), Category("01. General"), Description("OutputMode "), DisplayName("F. OutputMode")]
        public string OutputMode { get; set; }



        [TypeConverter(typeof(Resolution3D)), Category("01. General"), Description("FigSizeX"), DisplayName("G. FigSizeX")]
        public int FigSizeX { get; set; }


        [TypeConverter(typeof(Resolution3D)), Category("01. General"), Description("FigSizeY"), DisplayName("H. FigSizeY")]
        public int FigSizeY { get; set; }



        [TypeConverter(typeof(Resolution3D)), Category("01. General"), Description("Resolution of x or t"), DisplayName("I. Resolution of x or t")]
        public int Resolution { get; set; }


        [Category("01. General"), Description("If true, shows the x, y, and z axes"), DisplayName("Y. Show Axes")]
        public bool ShowAxes { get; set; }



        [Category("01. General"), Description("SvgPath"), DisplayName("Z. SvgPath")]
        ...
        [Tag("ScriptEvaluator"), Editor(typeof(MultilineStringEditor), typeof(UITypeEditor)), Category("02. Evaluation"), Description("Local Imports"), Browsable(true), DisplayName("A. Local Imports")]
        public string LocalImports { get; set; }



        [Tag("ScriptEvaluator"), Editor(typeof(MultilineStringEditor), typeof(UITypeEditor)), Category("02. Evaluation"), Description("The key word arguments which fine tune the result"), Browsable(true), DisplayName("B. Key word aguments")]
