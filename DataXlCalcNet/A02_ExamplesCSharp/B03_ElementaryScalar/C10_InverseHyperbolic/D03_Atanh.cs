...
#region TestAtanhReal

public static void TestAtanhReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAtanhReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "atanh(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.atanh(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.atanh(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.atanh(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.atanh(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.atanh(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.atanh(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.atanh(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.atanh(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.atanh(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.atanh(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.atanh(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.atanh(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.atanh(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.atanh(x);
...
#region TestAtanhCplx

public static void TestAtanhCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAtanhCplx" + "\"" + ">");
...
#region TestAtanhRealImag

public static void TestAtanhRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAtanhRealImag" + 
        "\"" + ">");
