...
#region TestAcoshReal

public static void TestAcoshReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcoshReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "acosh(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.acosh(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.acosh(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.acosh(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.acosh(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.acosh(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.acosh(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.acosh(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.acosh(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.acosh(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.acosh(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.acosh(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.acosh(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.acosh(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.acosh(x);
...
#region TestAcoshCplx

public static void TestAcoshCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcoshCplx" + "\"" + ">");
...
#region TestAcoshRealImag

public static void TestAcoshRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcoshRealImag" + 
        "\"" + ">");
