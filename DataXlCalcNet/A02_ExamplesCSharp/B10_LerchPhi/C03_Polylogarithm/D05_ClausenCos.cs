...
/* No syntax highlighting if HasArbPrecNet is undefined */
    ...
    TestClausenCosReal();
    TestClausenCosCplx();
    TestClausenCosRealImag();
}


#region TestClausenCosReal

public static void TestClausenCosReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestClausenCosReal" + "\"" + ">");
    ...
    foreach (Double z in InputArray2) {
        Console.WriteLine("<H2 Title=" + "\"" + "clausen_cos(s, z); s={0}, z={1}" 
            + "\"" + ">", s, z);
        Double res01 = math53.clausen_cos(s, z);
        Console.WriteLine("math53:  {0}", res01);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Single res08 = sflint.clausen_cos(s, z);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.clausen_cos(s, z);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.clausen_cos(s, z);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.clausen_cos(s, z);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.clausen_cos(s, z);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.clausen_cos(s, z);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.clausen_cos(s, z);
...
#region TestClausenCosCplx

public static void TestClausenCosCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestClausenCosCplx" + "\"" + ">");
    ...
    foreach (Complex z in InputArray2C) {
        Console.WriteLine("<H2 Title=" + "\"" + "clausen_cos(s, z); s={0}, z={1}" 
        + "\"" + ">", s, z);
        Complex res01 = cmath53.clausen_cos(s, z);
        Console.WriteLine("cmath53:  {0}", res01);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        SingleC res08 = sflintc.clausen_cos(s, z);
        Console.WriteLine("sflintc:  {0}", res08);
        Complex res09 = dflintc.clausen_cos(s, z);
        Console.WriteLine("dflintc:  {0}", res09);
        ExtendedC res10 = eflintc.clausen_cos(s, z);
        Console.WriteLine("eflintc:  {0}", res10);
        QuadrupleC res11 = qflintc.clausen_cos(s, z);
        Console.WriteLine("qflintc:  {0}", res11);
        OctupleC res12 = oflintc.clausen_cos(s, z);
        Console.WriteLine("oflintc:  {0}", res12);
        MpfrC res13 = mflintc.clausen_cos(s, z);
        Console.WriteLine("mflintc:  {0}", res13);
        ArbC res16 = aflintc.clausen_cos(s, z);
...
#region TestClausenCosRealImag

public static void TestClausenCosRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestClausenCosRealImag" + "\"" + ">");
    ...
    foreach (var IsReal in ReImArray) {
        ...
        Console.WriteLine("<H2 Title=" + "\"" + ReIm + "clausen_cos(s, z)); s={0}, z={1}" 
            + "\"" + ">", s, z);

        Complex res01c = cmath53.clausen_cos(s, z);
        Double res01 = IsReal ? res01c.Real : res01c.Imaginary;
        Console.WriteLine("cmath53:  {0}", res01);

#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        SingleC res08c = sflintc.clausen_cos(s, z);
        Single res08 = IsReal ? res08c.real : res08c.imag;
        Console.WriteLine("sflintc:  {0}", res08);

        Complex res09c = dflintc.clausen_cos(s, z);
        Double res09 = IsReal ? res09c.Real : res09c.Imaginary;
        Console.WriteLine("dflintc:  {0}", res09);

        ExtendedC res10c = eflintc.clausen_cos(s, z);
        Extended res10 = IsReal ? res10c.real : res10c.imag;
        Console.WriteLine("eflintc:  {0}", res10);

        QuadrupleC res11c = qflintc.clausen_cos(s, z);
        Quadruple res11 = IsReal ? res11c.real : res11c.imag;
        Console.WriteLine("qflintc:  {0}", res11);

        OctupleC res12c = oflintc.clausen_cos(s, z);
        Octuple res12 = IsReal ? res12c.real : res12c.imag;
        Console.WriteLine("oflintc:  {0}", res12);

        MpfrC res13c = mflintc.clausen_cos(s, z);
        Mpfr res13 = IsReal ? res13c.real : res13c.imag;
        Console.WriteLine("mflintc:  {0}", res13);

        ArbC res16c = aflintc.clausen_cos(s, z);
