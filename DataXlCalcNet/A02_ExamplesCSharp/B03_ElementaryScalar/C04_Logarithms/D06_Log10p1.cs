...
#region TestLog10p1Real

public static void TestLog10p1Real()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLog10p1Real" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "log10p1(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.log10p1(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.log10p1(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.log10p1(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.log10p1(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.log10p1(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.log10p1(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.log10p1(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.log10p1(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.log10p1(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.log10p1(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.log10p1(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.log10p1(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.log10p1(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.log10p1(x);
...
#region TestLog10p1Cplx

public static void TestLog10p1Cplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLog10p1Cplx" + "\"" + ">");
    ...
    foreach (var x in InputArray1C) {
        Console.WriteLine("<H2 Title=" + "\"" + "log10p1(x); " + "x={0}" + 
            "\"" + ">", x);
        Complex res01 = cmath53.log10p1(x);
        Console.WriteLine("cmath53:  {0}", res01);
        SingleC res02 = scplx.log10p1(x);
        Console.WriteLine("  scplx:  {0}", res02);
        Complex res03 = dcplx.log10p1(x);
        Console.WriteLine("  dcplx:  {0}", res03);
        ExtendedC res04 = ecplx.log10p1(x);
        Console.WriteLine("  ecplx:  {0}", res04);
        QuadrupleC res05 = qcplx.log10p1(x);
        Console.WriteLine("  qcplx:  {0}", res05);
        OctupleC res06 = ocplx.log10p1(x);
        Console.WriteLine("  ocplx:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        MpfrC res07 = mcplx.log10p1(x);
        Console.WriteLine("  mcplx:  {0}", res07);
        SingleC res08 = sflintc.log10p1(x);
        Console.WriteLine("sflintc:  {0}", res08);
        Complex res09 = dflintc.log10p1(x);
        Console.WriteLine("dflintc:  {0}", res09);
        ExtendedC res10 = eflintc.log10p1(x);
        Console.WriteLine("eflintc:  {0}", res10);
        QuadrupleC res11 = qflintc.log10p1(x);
        Console.WriteLine("qflintc:  {0}", res11);
        OctupleC res12 = oflintc.log10p1(x);
        Console.WriteLine("oflintc:  {0}", res12);
        MpfrC res13 = mflintc.log10p1(x);
        Console.WriteLine("mflintc:  {0}", res13);
        ArbC res16 = aflintc.log10p1(x);
...
#region TestLog10p1RealImag

public static void TestLog10p1RealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLog10p1RealImag" + 
        "\"" + ">");
