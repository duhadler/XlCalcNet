...
public static void TestSignCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSignCplx" + "\"" + ">");
...
#region TestSignRealImag

public static void TestSignRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSignRealImag" + 
        "\"" + ">");
