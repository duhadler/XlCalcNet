...
inline void airy(std::complex<double> z, std::complex<double> &ai, std::complex<double> &aip,
...
inline void airyai(int kode, std::complex<double> z, std::complex<double> &ai) {
    int id = 0;
    int ierr = 0;
    //int kode = 1;
    int nz;
...
inline void airybi(int kode, std::complex<double> z, std::complex<double> &bi) {
    int id = 0;
    int ierr = 0;
    //int kode = 1;
    int nz;
...
inline void airyaip(int kode, std::complex<double> z, std::complex<double> &aip) {
    int id = 0;
    int ierr = 0;
    //int kode = 1;
    int nz;
...
inline void airybip(int kode, std::complex<double> z, std::complex<double> &bip) {
    int id = 0;
    int ierr = 0;
    //int kode = 1;
    int nz;
...
void airye(std::complex<double> z, std::complex<double> &ai, std::complex<double> &aip, std::complex<double> &bi, std::complex<double> &bip) {
    int id = 0;
    int kode = 2; /* Exponential scaling */
    int nz, ierr;
...
void airy(T x, T &ai, T &aip, T &bi, T &bip) {
    ...
    if (x < -10 || x > 10) {
        ...
        airy(std::complex<T>(x), zai, zaip, zbi, zbip);
        ai = std::real(zai);
        aip = std::real(zaip);
        bi = std::real(zbi);
        bip = std::real(zbip);
