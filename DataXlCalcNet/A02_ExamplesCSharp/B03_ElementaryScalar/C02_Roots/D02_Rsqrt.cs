...
#region TestRsqrtReal

public static void TestRsqrtReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestRsqrtReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "rsqrt(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.rsqrt(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.rsqrt(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.rsqrt(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.rsqrt(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.rsqrt(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.rsqrt(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.rsqrt(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.rsqrt(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.rsqrt(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.rsqrt(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.rsqrt(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.rsqrt(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.rsqrt(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.rsqrt(x);
...
#region TestRsqrtCplx

public static void TestRsqrtCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestRsqrtCplx" + "\"" + ">");
...
#region TestRsqrtRealImag

public static void TestRsqrtRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestRsqrtRealImag" + 
        "\"" + ">");
