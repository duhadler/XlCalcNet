...
public static void TestCschCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCschCplx" + "\"" + ">");
...
#region TestCschRealImag

public static void TestCschRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCschRealImag" + 
        "\"" + ">");
