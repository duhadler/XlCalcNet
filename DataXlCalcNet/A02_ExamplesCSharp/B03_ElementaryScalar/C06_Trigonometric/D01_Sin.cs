...
public static void TestSinCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSinCplx" + "\"" + ">");
...
#region TestSinRealImag

public static void TestSinRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSinRealImag" + 
        "\"" + ">");
