...
public static void TestAcosCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcosCplx" + "\"" + ">");
...
#region TestAcosRealImag

public static void TestAcosRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcosRealImag" + 
        "\"" + ">");
