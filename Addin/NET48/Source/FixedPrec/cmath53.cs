...
namespace FixedPrecNet
{
    ...
    public static class EllipticFunctions
    {
        ...
        public static Complex _omega1_from_g2g3(Double g2, Double g3)
        {
            return _omega1_and_tau(new Tuple<Complex, Complex>(new Complex(g2, 0), new Complex(g3, 0))).Item1;
        }


        public static Complex _tau_from_g2g3(Double g2, Double g3)
        {
        ...
        public static Tuple<Complex, Complex> ellipticInvariants(Complex omega1, Complex omega2)
        {
            ...
            Complex j2 = _jtheta2_raw(0, tau);
            Complex j3 = _jtheta3_raw(0, tau);
            Complex g2 = (4.0 / 3.0) * Complex.Pow(Math.PI / 2.0 / omega1, 4) * (Complex.Pow(j2, 8) - Complex.Pow(j2 * j3, 4) + Complex.Pow(j3, 8));

            Complex g3 = (8.0 / 27.0) * Complex.Pow(Math.PI / 2.0 / omega1, 6) * (Complex.Pow(j2, 12) - (1.5 * Complex.Pow(j2, 8) * Complex.Pow(j3, 4) + 1.5 * Complex.Pow(j2, 4) * Complex.Pow(j3, 8)) + Complex.Pow(j3, 12.0));
...

    {
        ...
        {
            if (m == 0) return cmath53.digamma(z);
    ...
    public partial class cmath53
    {
        ...
        public static Complex polygamma(int m, Complex z)
        {
            return FromJulia.polygamma(m, z);
        }
        ...
        public static Complex hurwitz_zeta(Complex s, Complex a)
        {
            ...
            return FromJulia.GenZeta(s, a + m) + sum;
        }

        public static Complex gen_zeta(Complex s, Complex a)
        {
            return FromJulia.GenZeta(s, a);
        }
