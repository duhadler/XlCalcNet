...
public static void TestSqrCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSqrCplx" + "\"" + ">");
...
#region TestSqrRealImag

public static void TestSqrRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSqrRealImag" + 
        "\"" + ">");
