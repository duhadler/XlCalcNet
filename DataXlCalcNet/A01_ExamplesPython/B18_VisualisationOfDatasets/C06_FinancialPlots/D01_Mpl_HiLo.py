...
# See: https://github.com/matplotlib/mplfinance?tab=readme-ov-file#usage
# See also: https://github.com/matplotlib/mplfinance/wiki/Acessing-mplfinance-Figure-and-Axes-objects


def MplHiLo(**kwargs):
    OutputDir = kwargs['OutputDir'] if 'OutputDir' in kwargs else 'OutputMonitor'
    Title = kwargs['Title'] if 'Title' in kwargs else 'MplHiLo'
...
# End of custom key word arguments
    ...
    fig, axlist = mpf.plot(daily, returnfig=True)
