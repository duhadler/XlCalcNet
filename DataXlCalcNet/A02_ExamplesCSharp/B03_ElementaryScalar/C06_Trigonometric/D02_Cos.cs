...
public static void TestCosCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCosCplx" + "\"" + ">");
...
#region TestCosRealImag

public static void TestCosRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCosRealImag" + 
        "\"" + ">");
