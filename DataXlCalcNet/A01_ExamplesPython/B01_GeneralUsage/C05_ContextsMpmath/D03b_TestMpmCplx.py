...
def general_assignments():
    ...
    print('z = mpm.t("3", "4"):', z)
    z = mpm.t(3.0, 4.0)
    print('z = mpm.t(3.0, 4.0):', z)
    z = mpm.t(3, 4)
    print('z = mpm.t(3, 4):', z)
    z = mpm.t(3+4j)
    print('z = mpm.t(3+4j):', z)
    c = complex(3,4)
...
def arithmetic_operators_with_mpc():
    print()
    print('<H1 Title="Arithmetic operators with mpm">')
    z = mpm.t(5.7, 6.3)
    print('z = mpm.t(5.7, 6.3):', z)
    x = mpm.t(3.9, 7.8)
    print('x = mpm.t(3.9, 7.8):', x)
    y = x + z
    print('y = x + z:', y)
    y = z + x
    print('y = z + x:', y)
...
def arithmetic_comparisons_with_mpm():
    print()
    print('<H1 Title="Arithmetic comparisons with mpm">')
