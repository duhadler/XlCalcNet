...
public static void TestSinhCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSinhCplx" + "\"" + ">");
...
#region TestSinhRealImag

public static void TestSinhRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSinhRealImag" + 
        "\"" + ">");
