...
namespace FixedPrecNet
{
    ...
    //public delegate Octuple cb1SRet1S(Octuple x);

    //public delegate void cb1S1V(Octuple t, OctupleVec matX);

    //public delegate void cb1S2V(Octuple t, OctupleVec matX, OctupleVec matY);


    //public delegate void cb2M(OctupleMat matX, OctupleMat matY);


    //public delegate Octuple cb1VRet1S(OctupleVec x);

    //public delegate void cb2V(OctupleVec x, OctupleVec y);

    //public delegate void cb1V1M(OctupleVec x, OctupleMat y);
    ...
    public partial class oreal
    {
        ...
        public static Tuple<Octuple, Octuple, int> BracketRoot(cb1SRet1S f, dynamic guess, dynamic factor, bool is_rising, int get_digits, uint maxit)
        {
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/BracketRoot/*' />
        public static Tuple<Octuple, Octuple, int> BracketRoot(cb1SRet1S f, Octuple guess, Octuple factor, bool is_rising, int get_digits, uint maxit)
        {
        ...
        internal class OBracketRoot
        {
            ...
            public OBracketRoot(cb1SRet1S F1, Octuple guess, Octuple factor, bool is_rising, int get_digits, uint maxit)
            {
                F1_ = F1;
                guess_ = guess;
                factor_ = factor;
        ...
        public static Tuple<Octuple, int> NewtonRaphson(cb1SRet1S f, cb1SRet1S df, dynamic guess, dynamic xmin, dynamic xmax, int get_digits, uint maxit)
        {
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/NewtonRaphson/*' />
        public static Tuple<Octuple, int> NewtonRaphson(cb1SRet1S f, cb1SRet1S df, Octuple guess, Octuple xmin, Octuple xmax, int get_digits, uint maxit)
        {
        ...
        internal class ONewtonRaphson
        {
            ...
            public ONewtonRaphson(cb1SRet1S F1, cb1SRet1S DF1, Octuple guess, Octuple xmin, Octuple xmax, int get_digits, uint maxit)
            {
                F1_ = F1;
                DF1_ = DF1;
                guess_ = guess;
        ...
        public static Tuple<Octuple, int> Halley(cb1SRet1S f, cb1SRet1S df1, cb1SRet1S df2, dynamic guess, dynamic xmin, dynamic xmax, int get_digits, uint maxit)
        {
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/Halley/*' />
        public static Tuple<Octuple, int> Halley(cb1SRet1S f, cb1SRet1S df1, cb1SRet1S df2, Octuple guess, Octuple xmin, Octuple xmax, int get_digits, uint maxit)
        {
        ...
        internal class OHalley
        {
            ...
            public OHalley(cb1SRet1S F1, cb1SRet1S DF1, cb1SRet1S DF2, Octuple guess, Octuple xmin, Octuple xmax, int get_digits, uint maxit)
            {
                F1_ = F1;
                DF1_ = DF1;
                DF2_ = DF2;
        ...
        public static Tuple<Octuple, int> Schroder(cb1SRet1S f, cb1SRet1S df1, cb1SRet1S df2, dynamic guess, dynamic xmin, dynamic xmax, int get_digits, uint maxit)
        {
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/Schroder/*' />
        public static Tuple<Octuple, int> Schroder(cb1SRet1S f, cb1SRet1S df1, cb1SRet1S df2, Octuple guess, Octuple xmin, Octuple xmax, int get_digits, uint maxit)
        {
        ...
        internal class OSchroder
        {
            ...
            public OSchroder(cb1SRet1S F1, cb1SRet1S DF1, cb1SRet1S DF2, Octuple guess, Octuple xmin, Octuple xmax, int get_digits, uint maxit)
            {
                F1_ = F1;
                DF1_ = DF1;
                DF2_ = DF2;
        ...
        public static Tuple<Octuple, Octuple, int> Brent_Minimum(cb1SRet1S f, dynamic bracket_min, dynamic bracket_max, int bits, uint maxit)
        {
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/BrentMinimum/*' />
        public static Tuple<Octuple, Octuple, int> Brent_Minimum(cb1SRet1S f, Octuple bracket_min, Octuple bracket_max, int bits, uint maxit)
        {
        ...
        internal class OBrent_Minimum
        {
            ...
            public OBrent_Minimum(cb1SRet1S F1, Octuple bracket_min, Octuple bracket_max, int bits, uint maxit)
            {
                F1_ = F1;
        ...
        public static Tuple<Octuple, Octuple, Octuple> Trapezoidal(cb1SRet1S f, dynamic a, dynamic b, dynamic tol = null, uint max_refinements = 12)
        {
            if (tol == null) { tol = t(0); }
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/Trapezoidal/*' />
        public static Tuple<Octuple, Octuple, Octuple> Trapezoidal(cb1SRet1S f, Octuple a, Octuple b, Octuple tol, uint max_refinements = 12)
        {
        ...
        internal class OTrapezoidal
        {
            ...
            public OTrapezoidal(cb1SRet1S F1, Octuple a, Octuple b)
            {
                F1_ = F1;
                a_ = a;
                b_ = b;
        ...
        public static Tuple<Octuple, Octuple> GaussLegendre(cb1SRet1S f, dynamic a, dynamic b)
        {
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/GaussLegendre/*' />
        public static Tuple<Octuple, Octuple> GaussLegendre(cb1SRet1S f, Octuple a, Octuple b)
        {
        ...
        internal class OGaussLegendre
        {
            ...
            public OGaussLegendre(cb1SRet1S F1, Octuple a, Octuple b)
            {
                F1_ = F1;
                a_ = a;
                b_ = b;
        ...
        public static Tuple<Octuple, Octuple, Octuple> GaussKronrod(cb1SRet1S f, dynamic a, dynamic b, dynamic tol = null, uint max_depth = 12)
        {
            if (tol == null) { tol = t(0); }
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/GaussKronrod/*' />
        public static Tuple<Octuple, Octuple, Octuple> GaussKronrod(cb1SRet1S f, Octuple a, Octuple b, Octuple tol, uint max_depth = 12)
        {
        ...
        internal class OGaussKronrod
        {
            ...
            public OGaussKronrod(cb1SRet1S F1, Octuple a, Octuple b)
            {
                F1_ = F1;
                a_ = a;
                b_ = b;
        ...
        public static Tuple<Octuple, Octuple, Octuple, int> TanhSinh(cb1SRet1S f, dynamic a, dynamic b, dynamic tol = null, uint max_refinements = 12)
        {
            if (tol == null) { tol = t(0); }
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/TanhSinh/*' />
        public static Tuple<Octuple, Octuple, Octuple, int> TanhSinh(cb1SRet1S f, Octuple a, Octuple b, Octuple tol, uint max_refinements = 12)
        {
        ...
        internal class OTanhSinh
        {
            ...
            public OTanhSinh(cb1SRet1S F1, Octuple a, Octuple b)
            {
                F1_ = F1;
                a_ = a;
                b_ = b;
        ...
        public static Tuple<Octuple, Octuple, Octuple, int> SinhSinh(cb1SRet1S f, dynamic tol = null, uint max_refinements = 12)
        {
            if (tol == null) { tol = t(0); }
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/SinhSinh/*' />
        public static Tuple<Octuple, Octuple, Octuple, int> SinhSinh(cb1SRet1S f, Octuple tol, uint max_refinements = 12)
        {
        ...
        public static Tuple<Octuple, Octuple, Octuple, int> ExpSinh(cb1SRet1S f, dynamic tol = null, uint max_refinements = 12)
        {
            if (tol == null) { tol = t(0); }
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/ExpSinh/*' />
        public static Tuple<Octuple, Octuple, Octuple, int> ExpSinh(cb1SRet1S f, Octuple tol, uint max_refinements = 12)
        {
        ...
        public static Tuple<Octuple, Octuple> Ooura_Cos(cb1SRet1S f)
        {
        ...
        public static Tuple<Octuple, Octuple> Ooura_Sin(cb1SRet1S f)
        {
        ...
        public static void RungeKutta4Const(cb1S2V F1, cb1S1V F2, OctupleVec matInput, Octuple StartTime, Octuple EndTime, Octuple dt)
        {
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/RungeKutta4Const/*' />
        public static void RungeKutta4Const(cb1S2V F1, cb1S1V F2, OctupleVec matInput, dynamic StartTime, dynamic EndTime, dynamic dt)
        {
            RungeKutta4Const(F1, F2, matInput, t(StartTime), t(EndTime), t(dt));
        }


        public static void CashKarp54Const(cb1S2V F1, cb1S1V F2, OctupleVec matInput, Octuple StartTime, Octuple EndTime, Octuple dt)
        {
        ...
        public static void CashKarp54Const(cb1S2V F1, cb1S1V F2, OctupleVec matInput, dynamic StartTime, dynamic EndTime, dynamic dt)
        {
        ...
        public static void DormandPrince5Const(cb1S2V F1, cb1S1V F2, OctupleVec matInput, Octuple StartTime, Octuple EndTime, Octuple dt)
        {
        ...
        public static void DormandPrince5Const(cb1S2V F1, cb1S1V F2, OctupleVec matInput, dynamic StartTime, dynamic EndTime, dynamic dt)
        {
            DormandPrince5Const(F1, F2, matInput, t(StartTime), t(EndTime), t(dt));
        }


        public static void Fehlberg78Const(cb1S2V F1, cb1S1V F2, OctupleVec matInput, Octuple StartTime, Octuple EndTime, Octuple dt)
        {
        ...
        public static void Fehlberg78Const(cb1S2V F1, cb1S1V F2, OctupleVec matInput, dynamic StartTime, dynamic EndTime, dynamic dt)
        {
            Fehlberg78Const(F1, F2, matInput, t(StartTime), t(EndTime), t(dt));
        }


        public static void AdamsBashforthMoultonConst(cb1S2V F1, cb1S1V F2, OctupleVec matInput, Octuple StartTime, Octuple EndTime, Octuple dt)
        {
        ...
        public static void AdamsBashforthMoultonConst(cb1S2V F1, cb1S1V F2, OctupleVec matInput, dynamic StartTime, dynamic EndTime, dynamic dt)
        {
        ...
        internal class OOdeintConst
        {
            ...
            internal OOdeintConst(int what, cb1S2V F1, cb1S1V F2, OctupleVec matInit, Octuple StartTime, Octuple EndTime, Octuple dt)
            {
                what_ = what;
        ...
        public static void DormandPrince5Adaptive(cb1S2V F1, cb1S1V F2, OctupleVec matInput, Octuple StartTime, Octuple EndTime, Octuple dt, Octuple epsabs, Octuple epsrel)
        {
        ...
        /// <include file="docs.xml" path='docs/members[@name="Boost"]/DormandPrince5Adaptive/*' />
        public static void DormandPrince5Adaptive(cb1S2V F1, cb1S1V F2, OctupleVec matInput, dynamic StartTime, dynamic EndTime, dynamic dt, dynamic epsabs, dynamic epsrel)
        {
            DormandPrince5Adaptive(F1, F2, matInput, t(StartTime), t(EndTime), t(dt), t(epsabs), t(epsrel));
        }


        public static void CashKarp54Adaptive(cb1S2V F1, cb1S1V F2, OctupleVec matInput, Octuple StartTime, Octuple EndTime, Octuple dt, Octuple epsabs, Octuple epsrel)
        {
        ...
        public static void CashKarp54Adaptive(cb1S2V F1, cb1S1V F2, OctupleVec matInput, dynamic StartTime, dynamic EndTime, dynamic dt, dynamic epsabs, dynamic epsrel)
        {
        ...
        public static void Fehlberg78Adaptive(cb1S2V F1, cb1S1V F2, OctupleVec matInput, Octuple StartTime, Octuple EndTime, Octuple dt, Octuple epsabs, Octuple epsrel)
        {
        ...
        public static void Fehlberg78Adaptive(cb1S2V F1, cb1S1V F2, OctupleVec matInput, dynamic StartTime, dynamic EndTime, dynamic dt, dynamic epsabs, dynamic epsrel)
        {
            Fehlberg78Adaptive(F1, F2, matInput, t(StartTime), t(EndTime), t(dt), t(epsabs), t(epsrel));
        }


        public static void BulirschStoerAdaptive(cb1S2V F1, cb1S1V F2, OctupleVec matInput, Octuple StartTime, Octuple EndTime, Octuple dt, Octuple epsabs, Octuple epsrel)
        {
        ...
        public static void BulirschStoerAdaptive(cb1S2V F1, cb1S1V F2, OctupleVec matInput, dynamic StartTime, dynamic EndTime, dynamic dt, dynamic epsabs, dynamic epsrel)
        {
            BulirschStoerAdaptive(F1, F2, matInput, t(StartTime), t(EndTime), t(dt), t(epsabs), t(epsrel));
        }


        public static void DormandPrince5DenseOutput(cb1S2V F1, cb1S1V F2, OctupleVec matInput, Octuple StartTime, Octuple EndTime, Octuple dt, Octuple epsabs, Octuple epsrel)
        {
        ...
        public static void DormandPrince5DenseOutput(cb1S2V F1, cb1S1V F2, OctupleVec matInput, dynamic StartTime, dynamic EndTime, dynamic dt, dynamic epsabs, dynamic epsrel)
        {
            DormandPrince5DenseOutput(F1, F2, matInput, t(StartTime), t(EndTime), t(dt), t(epsabs), t(epsrel));
        }


        public static void BulirschStoerDenseOutput(cb1S2V F1, cb1S1V F2, OctupleVec matInput, Octuple StartTime, Octuple EndTime, Octuple dt, Octuple epsabs, Octuple epsrel)
        {
        ...
        public static void BulirschStoerDenseOutput(cb1S2V F1, cb1S1V F2, OctupleVec matInput, dynamic StartTime, dynamic EndTime, dynamic dt, dynamic epsabs, dynamic epsrel)
        {
        ...
        internal class OOdeintAdaptiveDenseOutput
        {
            ...
            internal OOdeintAdaptiveDenseOutput(int what, cb1S2V F1, cb1S1V F2, OctupleVec matInit, Octuple StartTime, Octuple EndTime, Octuple dt, Octuple epsabs, Octuple epsrel)
            {
                what_ = what;
                StartTime_ = StartTime;
                EndTime_ = EndTime;
        ...
        public static OctupleMat PowellHybrd(cb2M F1, cb2M F2, OctupleMat matInput)
        {
        ...
        internal class OPowellHybrd
        {
            ...
            internal OPowellHybrd(cb2M F1, cb2M F2, OctupleMat matInput)
            {
                int n = matInput.rows;
                matX.Resize(n, 1);
                matFvec.Resize(n, 1);
        ...
        public static OctupleMat LevenbergMarquardt(cb2M F1, cb2M F2, OctupleMat matInput, int n, int m)
        {
        ...
        internal class OLevenberg
        {
            ...
            internal OLevenberg(cb2M F1, cb2M F2, OctupleMat matInput, int n, int m)
            {
                matX.Resize(n, 1);
                matFvec.Resize(m, 1);
                matFjac.Resize(n, n);
        ...
        public static OctupleVec NelderMeadSolver(cb1VRet1S F1, OctupleVec matInput)
        {
            var OSolver11 = new OOptSolver1(constants.mp_nelder_mead_solver, F1, matInput);
            return OSolver11.Solve();
        }

        public static OctupleVec CMAesSolver(cb1VRet1S F1, OctupleVec matInput)
        {
        ...
        internal class OOptSolver1
        {
            ...
            internal OOptSolver1(int what, cb1VRet1S F1, OctupleVec X)
            {
                what_ = what;
        ...
        public static OctupleVec LbfgsSolver(cb1VRet1S F1, cb2V F2, OctupleVec matInput)
        {
            var OSolver21 = new OOptSolver2(constants.mp_lbfgs_solver, F1, F2, matInput);
            return OSolver21.Solve();
        }

        public static OctupleVec BfgsSolver(cb1VRet1S F1, cb2V F2, OctupleVec matInput)
        {
            var OSolver21 = new OOptSolver2(constants.mp_bfgs_solver, F1, F2, matInput);
            return OSolver21.Solve();
        }

        public static OctupleVec GradientDescentSolver(cb1VRet1S F1, cb2V F2, OctupleVec matInput)
        {
            var OSolver21 = new OOptSolver2(constants.mp_gradient_descent_solver, F1, F2, matInput);
            return OSolver21.Solve();
        }

        public static OctupleVec ConjugatedGradientDescentSolver(cb1VRet1S F1, cb2V F2, OctupleVec matInput)
        {
        ...
        internal class OOptSolver2
        {
            ...
            internal OOptSolver2(int what, cb1VRet1S F1, cb2V F2, OctupleVec X)
            {
                what_ = what;
                matX_ = new OctupleVec(X.Size);
        ...
        public static OctupleVec NewtonDescentSolver(cb1VRet1S F1, cb2V F2, cb1V1M F3, OctupleVec matInput)
        {
        ...
        internal class OOptSolver3
        {
            ...
            internal OOptSolver3(int what, cb1VRet1S F1, cb2V F2, cb1V1M F3, OctupleVec X)
            {
                what_ = what;
                matX_ = new OctupleVec(X.Size);
                matGrad_ = new OctupleVec(X.Size);
        ...
        public static int mat_rows(OctupleMat matA)
        {
            return matA.rows;
        }
        ...
        public static int mat_cols(OctupleMat matA)
        {
            return matA.cols;
        }
        ...
        /// <include file="docs.xml" path='docs/members[@name="Eigen"]/mat_cols/*' />
        public static int mat_size(OctupleMat matA)
        {
            return matA.size;
        }
        ...
        public static OctupleMat mat_get_block(OctupleMat matA, int i, int j, int p, int q)
        {
        ...
        public static void mat_set_block(OctupleMat matA, int i, int j, int p, int q, OctupleMat matB)
        {
        ...
        public static OctupleMat mat_get_row(OctupleMat matA, int i)
        {
        ...
        public static void mat_set_row(OctupleMat matA, int i, OctupleMat matB)
        {
            matA.set_Row(i, matB);
        }
        ...
        public static OctupleMat mat_get_col(OctupleMat matA, int i)
        {
        ...
        public static void mat_set_col(OctupleMat matA, int i, OctupleMat matB)
        {
            matA.set_Col(i, matB);
        }
        ...
        public static OctupleMat mat_get_diagonal(OctupleMat matA, int q = 0)
        {
        ...
        public static void mat_set_diagonal(OctupleMat matA, int q, OctupleMat matB)
        {
        ...
        public static OctupleMat mat_get_triangular_view(OctupleMat matA, int view = 1)
        {
        ...
        public static void mat_set_triangular_view(OctupleMat matA, int view, OctupleMat matB)
        {
        ...
        public static void mat_sort(OctupleMat matA, int sort_order = 0, int sort_criterion = 1)
        {
        ...
        public static void mat_sort_rows_by_col(OctupleMat matA, int column_to_sort_by = 0, int sort_order = 0, int sort_criterion = 1)
        {
        ...
        public static void mat_resize(OctupleMat matA, int r, int c)
        {
            matA.Resize(r, c);
        }
        ...
        public static void mat_resize_like(OctupleMat matA, OctupleMat matB)
        {
        ...
        public static void mat_conservative_resize(OctupleMat matA, int r, int c)
        {
        ...
        public static OctupleMat mat_as_diagonal(OctupleMat matA)
        {
        ...
        public static OctupleMat mat_adjoint(OctupleMat matA)
        {
            return matA.Adjoint();
        }
        ...
        public static OctupleMat mat_conjugate(OctupleMat matA)
        {
        ...
        public static OctupleMat mat_transpose(OctupleMat matA)
        {
        ...
        public static OctupleMat mat_reverse_full(OctupleMat matA)
        {
        ...
        public static OctupleMat mat_reverse_row_wise(OctupleMat matA)
        {
        ...
        public static OctupleMat mat_reverse_col_wise(OctupleMat matA)
        {
        ...
        public static OctupleMat mat_replicate_full(OctupleMat matA, int vertical, int horizontal)
        {
        ...
        public static OctupleMat mat_replicate_row_wise(OctupleMat matA, int horizontal)
        {
        ...
        public static OctupleMat mat_replicate_col_wise(OctupleMat matA, int vertical)
        {
        ...
        public static OctupleMat mat_concat_horizontal(OctupleMat matA, OctupleMat matB)
        {
        ...
        public static OctupleMat mat_concat_vertical(OctupleMat matA, OctupleMat matB)
        {
        ...
        public static OctupleMat mat_sum(OctupleMat matA, int partialmode)
        {
        ...
        public static OctupleMat mat_prod(OctupleMat matA, int partialmode)
        {
        ...
        public static OctupleMat mat_mean(OctupleMat matA, int partialmode)
        {
        ...
        public static OctupleMat mat_min_coeff(OctupleMat matA, int partialmode)
        {
        ...
        public static OctupleMat mat_max_coeff(OctupleMat matA, int partialmode)
        {
        ...
        public static Octuple mat_trace(OctupleMat matA, int partialmode)
        {
        ...
        public static OctupleMat mat_squared_norm(OctupleMat matA, int partialmode)
        {
        ...
        public static OctupleMat mat_norm(OctupleMat matA, int partialmode)
        {
        ...
        public static OctupleMat mat_stable_norm(OctupleMat matA, int partialmode)
        {
        ...
        //public static OctupleMat mat_covariance(OctupleMat matA)
        //{
        ...
        public static OctupleMatMap mat_ldlt(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatMap mat_partial_piv_lu(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatMap mat_full_piv_lu(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        //public static OctupleMatMap mat_llt(OctupleMat matA, string query, [Optional] OctupleMat matB)
        //{
        ...
        /// <include file="docs.xml" path='docs/members[@name="Eigen"]/mat_llt/*' />
        public static OctupleMatMap mat_llt(OctupleMat matA, string query, OctupleMat matB)
        {
            return matA.LLT(query, matB);
        }
        ...
        public static OctupleMatMap mat_householder_qr(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatMap mat_col_piv_householder_qr(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatMap mat_full_piv_householder_qr(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatMap mat_cod_householder_qr(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatMap mat_jacobi_svd(OctupleMat matA, string query)
        {
        ...
        public static OctupleMatMap mat_jacobi_svd_thin(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatMap mat_jacobi_svd_full(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatMap mat_self_adjoint_eigen_values(OctupleMat matA, string query)
        {
        ...
        public static OctupleMatMap mat_self_adjoint_eigen_system(OctupleMat matA, string query)
        {
        ...
        public static OctupleMatMap mat_generalized_self_adjoint_eigen_values(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatMap mat_generalized_self_adjoint_eigen_system(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatMap mat_tridiagonalization(OctupleMat matA, string query)
        {
        ...
        public static OctupleMatMap mat_hessenberg(OctupleMat matA, string query)
        {
        ...
        public static OctupleMatMap mat_schur(OctupleMat matA, string query)
        {
        ...
        public static OctupleMatMapC mat_eigen_values(OctupleMat matA, string query)
        {
        ...
        public static OctupleMatMapC mat_eigen_system(OctupleMat matA, string query)
        {
        ...
        public static OctupleMatMap mat_real_qz(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatMap mat_pseudo_eigen_system(OctupleMat matA, string query)
        {
        ...
        public static OctupleMatMapC mat_gen_eigen_values(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatMapC mat_gen_eigen_system(OctupleMat matA, string query, OctupleMat matB)
        {
        ...
        public static OctupleMatC mat_fft_fwd(OctupleMat matA)
        {
            return matA.FFTFwd();
        }
        ...
        public static OctupleMat mat_fft_inv(OctupleMatC matA)
        {
        ...
        public static OctupleMat mat_expm(OctupleMat matA)
        {
            return matA.ExpMat();
        }
        ...
        public static OctupleMat mat_sinm(OctupleMat matA)
        {
            return matA.SinMat();
        }
        ...
        public static OctupleMat mat_cosm(OctupleMat matA)
        {
            return matA.CosMat();
        }
        ...
        public static OctupleMat mat_sinhm(OctupleMat matA)
        {
            return matA.SinhMat();
        }
        ...
        public static OctupleMat mat_coshm(OctupleMat matA)
        {
            return matA.CoshMat();
        }
        ...
        public static OctupleMat mat_sqrtm(OctupleMat matA)
        {
            return matA.SqrtMat();
        }
        ...
        public static OctupleMat mat_logm(OctupleMat matA)
        {
            return matA.LogMat();
        }
        ...
        public static OctupleMat mat_powm(OctupleMat matA, Double r)
        {
            return matA.PowMat();
        }
        ...
        public static OctupleMat roots_to_monic_poly(OctupleMat vecA)
        {
        ...
        public static OctupleMat poly_eval(OctupleMat polyA, OctupleMat roots)
        {
        ...
        /// <include file="docs.xml" path='docs/members[@name="Eigen"]/poly_eval/*' />
        public static OctupleMatC poly_eval(OctupleMat polyA, OctupleMatC roots)
        {
            return polyA.PolyEval(roots);
        }
        ...
        public static OctupleMatC poly_solve(OctupleMat polyA)
        {
