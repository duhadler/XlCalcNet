...
def general_assignments():
    ...
    x = qpm.t(5.7)
    print('x = qpm.t(5.7):', x)
    x0 = qpm.t(2329456398453948563945639364827346)
    print('x0 = qpm.t(2329456398453948563945639364827346', x0)
    x1 = qpm.t("2329456398453948563945639364827346")
    print('x1 = qpm.t("2329456398453948563945639364827346"):', x1)
    x = qpm.t("5.5")
    print('x = qpm.t("5.5"):', x)
...
#    z = qpm.exp(dec)
#    print('z = qpm.exp(dec):', z)
#    frac = Fraction("-3/7")
#    print('frac = Fraction("-3/7:")', frac)
#    z = qpm.exp(frac)
#    print('z = qpm.exp(frac):', z)
    ...
    print('y = qpm.t(33):', y)
#    z = qpm.pow(x, y)
#    print('z = qpm.pow(x, y):        ', z)
#    z = qpm.pow(5.5, 3.3)
#    print('z = qpm.pow(5.5, 3.3):    ', z)
#    z = qpm.pow("5.5", "3.3")
#    print('z = qpm.pow("5.5", "3.3"):', z)
#    z = qpm.pow(5, 3)
#    print('z = qpm.pow(5, 3):', z)
#
#    t = z + 3
#    print('t = z + 3:', t)
    print('</H1>')
...
def arithmetic_operators_with_mpm():
    print()
    print('<H1 Title="Arithmetic operators with qpm">')
...
def arithmetic_comparisons_with_mpm():
    print()
    print('<H1 Title="Arithmetic comparisons with qpm">')
...
#    xMat = qpm.Mat.Random(2,2)
#    print('xMat = qpm.Mat.Random(2,2): \n', xMat)
#
#    xcoeff = qpm.t(4.5)
#    print('xcoeff = qpm.t(4.5): ', xcoeff)
#
#    xMat[1,1] = xcoeff
