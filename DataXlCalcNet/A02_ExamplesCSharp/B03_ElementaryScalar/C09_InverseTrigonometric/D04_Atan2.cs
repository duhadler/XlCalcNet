...
#region TestAtan2Real

public static void TestAtan2Real()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAtan2Real" + "\"" + ">");
    Double[] InputArray1 = { -4.333, 0.0, 4.333000001 };
    Double[] InputArray2 = { -4.333, 0.0, 4.333 };
    foreach (Double y in InputArray1) {
    foreach (Double x in InputArray2) {
        Console.WriteLine("<H2 Title=" + "\"" + "atan2(y, x); y={0}, x={1}" 
            + "\"" + ">", y, x);
        Double res01 = math53.atan2(y, x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.atan2(y, x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.atan2(y, x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.atan2(y, x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.atan2(y, x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.atan2(y, x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.atan2(y, x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.atan2(y, x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.atan2(y, x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.atan2(y, x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.atan2(y, x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.atan2(y, x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.atan2(y, x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.atan2(y, x);
