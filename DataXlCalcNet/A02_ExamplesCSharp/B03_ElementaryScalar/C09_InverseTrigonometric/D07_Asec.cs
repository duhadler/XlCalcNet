...
public static void TestAsecCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAsecCplx" + "\"" + ">");
...
#region TestAsecRealImag

public static void TestAsecRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAsecRealImag" + 
        "\"" + ">");
