...
#region TestPolylogReal

public static void TestPolylogReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestPolylogReal" + "\"" + ">");
    ...
    foreach (Double z in InputArray2) {
        Console.WriteLine("<H2 Title=" + "\"" + "polylog(s, z); s={0}, z={1}" 
            + "\"" + ">", s, z);
        Double res01 = math53.polylog(s, z);
        Console.WriteLine("math53:  {0}", res01);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Single res08 = sflint.polylog(s, z);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.polylog(s, z);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.polylog(s, z);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.polylog(s, z);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.polylog(s, z);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.polylog(s, z);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.polylog(s, z);
...
#region TestPolylogCplx

public static void TestPolylogCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestPolylogCplx" + "\"" + ">");
    ...
    foreach (Complex z in InputArray2C) {
        Console.WriteLine("<H2 Title=" + "\"" + "polylog(s, z); s={0}, z={1}" 
        + "\"" + ">", s, z);
        Complex res01 = cmath53.polylog(s, z);
        Console.WriteLine("cmath53:  {0}", res01);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        SingleC res08 = sflintc.polylog(s, z);
        Console.WriteLine("sflintc:  {0}", res08);
        Complex res09 = dflintc.polylog(s, z);
        Console.WriteLine("dflintc:  {0}", res09);
        ExtendedC res10 = eflintc.polylog(s, z);
        Console.WriteLine("eflintc:  {0}", res10);
        QuadrupleC res11 = qflintc.polylog(s, z);
        Console.WriteLine("qflintc:  {0}", res11);
        OctupleC res12 = oflintc.polylog(s, z);
        Console.WriteLine("oflintc:  {0}", res12);
        MpfrC res13 = mflintc.polylog(s, z);
        Console.WriteLine("mflintc:  {0}", res13);
        ArbC res16 = aflintc.polylog(s, z);
...
#region TestPolylogRealImag

public static void TestPolylogRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestPolylogRealImag" + "\"" + ">");
    ...
    foreach (var IsReal in ReImArray) {
        ...
        Console.WriteLine("<H2 Title=" + "\"" + ReIm + "polylog(s, z)); s={0}, z={1}" 
            + "\"" + ">", s, z);

        Complex res01c = cmath53.polylog(s, z);
        Double res01 = IsReal ? res01c.Real : res01c.Imaginary;
        Console.WriteLine("cmath53:  {0}", res01);

#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        SingleC res08c = sflintc.polylog(s, z);
        Single res08 = IsReal ? res08c.real : res08c.imag;
        Console.WriteLine("sflintc:  {0}", res08);

        Complex res09c = dflintc.polylog(s, z);
        Double res09 = IsReal ? res09c.Real : res09c.Imaginary;
        Console.WriteLine("dflintc:  {0}", res09);

        ExtendedC res10c = eflintc.polylog(s, z);
        Extended res10 = IsReal ? res10c.real : res10c.imag;
        Console.WriteLine("eflintc:  {0}", res10);

        QuadrupleC res11c = qflintc.polylog(s, z);
        Quadruple res11 = IsReal ? res11c.real : res11c.imag;
        Console.WriteLine("qflintc:  {0}", res11);

        OctupleC res12c = oflintc.polylog(s, z);
        Octuple res12 = IsReal ? res12c.real : res12c.imag;
        Console.WriteLine("oflintc:  {0}", res12);

        MpfrC res13c = mflintc.polylog(s, z);
        Mpfr res13 = IsReal ? res13c.real : res13c.imag;
        Console.WriteLine("mflintc:  {0}", res13);

        ArbC res16c = aflintc.polylog(s, z);
