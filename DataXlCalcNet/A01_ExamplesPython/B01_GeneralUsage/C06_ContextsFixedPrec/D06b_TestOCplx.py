...
import math
from xlcalcnet import oreal, ocplx
...
def main_tests():
    ...
    arithmetic_operators_with_ocplx()
    ...
    arithmetic_comparisons_with_ocplx()
...
def general_assignments():
    ...
    z = ocplx.t("3", "4")
    print('z = ocplx.t("3", "4"):', z)
    z = ocplx.t(3.0, 4.0)
    print('z = ocplx.t(3.0, 4.0):', z)
    z = ocplx.t(3, 4)
    print('z = ocplx.t(3, 4):', z)
    z = ocplx.t(3+4j)
    print('z = ocplx.t(3+4j):', z)
    c = complex(3,4)
    print('c = complex(3,4):', c)
    z = ocplx.t(c)
    print('z = ocplx.t(c):', z)
    z = ocplx.t(1j)
    print('z = ocplx.t(1j):', z)
    z = ocplx.t(1)
    print('z = ocplx.t(1):', z)
    z = ocplx.t(1.1)
    print('z = ocplx.t(1.1):', z)
    print('</H1>')
...
def functions_with_argument_conversion():
    ...
    print('z = ocplx.t(3+4j):', z)
    z = ocplx.exp(z)
    print('z = ocplx.exp(z):', z)
    z = ocplx.exp(3+4j)
    print('z = ocplx.exp(3+4j):', z)
    z = ocplx.exp(5)
    print('z = ocplx.exp(5):', z)
    print('</H1>')


def arithmetic_operators_with_ocplx():
    print()
    print('<H1 Title="Arithmetic operators with ocplx">')
    z = ocplx.t(5.7, 6.3)
    print('z = ocplx.t(5.7, 6.3):', z)
    x = ocplx.t(3.9, 7.8)
    print('x = ocplx.t(3.9, 7.8):', x)
    y = x + z
    print('y = x + z:', y)
    y = z + x
    print('y = z + x:', y)
...
def arithmetic_comparisons_with_ocplx():
    print()
    print('<H1 Title="Arithmetic comparisons with ocplx">')
