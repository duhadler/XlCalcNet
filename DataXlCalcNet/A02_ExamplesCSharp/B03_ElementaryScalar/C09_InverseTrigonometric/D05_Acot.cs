...
public static void TestAcotCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcotCplx" + "\"" + ">");
...
#region TestAcotRealImag

public static void TestAcotRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcotRealImag" + 
        "\"" + ">");
