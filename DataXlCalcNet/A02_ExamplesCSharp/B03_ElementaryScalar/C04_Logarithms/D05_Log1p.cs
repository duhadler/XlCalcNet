...
#region TestLog1pReal

public static void TestLog1pReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLog1pReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "log1p(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.log1p(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.log1p(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.log1p(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.log1p(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.log1p(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.log1p(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.log1p(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.log1p(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.log1p(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.log1p(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.log1p(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.log1p(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.log1p(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.log1p(x);
...
#region TestLog1pCplx

public static void TestLog1pCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLog1pCplx" + "\"" + ">");
...
#region TestLog1pRealImag

public static void TestLog1pRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLog1pRealImag" + 
        "\"" + ">");
