...
public static void TestLogCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLogCplx" + "\"" + ">");
...
#region TestLogRealImag

public static void TestLogRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLogRealImag" + 
        "\"" + ">");
