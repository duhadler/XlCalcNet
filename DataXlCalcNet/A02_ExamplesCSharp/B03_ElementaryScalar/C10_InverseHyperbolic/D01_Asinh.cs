...
#region TestAsinhReal

public static void TestAsinhReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAsinhReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "asinh(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.asinh(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.asinh(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.asinh(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.asinh(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.asinh(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.asinh(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.asinh(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.asinh(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.asinh(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.asinh(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.asinh(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.asinh(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.asinh(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.asinh(x);
...
#region TestAsinhCplx

public static void TestAsinhCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAsinhCplx" + "\"" + ">");
...
#region TestAsinhRealImag

public static void TestAsinhRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAsinhRealImag" + 
        "\"" + ">");
