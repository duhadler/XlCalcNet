...
addin_version = "1.00"
addin_displayname = "MpFunlab Add-In."
...
desc_xml.write('<icon> \n')
desc_xml.write('	<default xlink:href="icons/mpfunlab.png" /> \n')
desc_xml.write('</icon> \n')
desc_xml.write('\n')
...
add_manifest_entry(manifest_xml, 'basic-library', 'MpFunLabWin/')
...
add_manifest_entry(manifest_xml, 'uno-component;type=Python', 'mpfunlab.py')
manifest_xml.write('</manifest:manifest> \n')
