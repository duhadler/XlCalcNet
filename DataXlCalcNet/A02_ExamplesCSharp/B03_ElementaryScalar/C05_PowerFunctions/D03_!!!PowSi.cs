...
#region TestPowSiReal

public static void TestPowSiReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestPowSiReal" + "\"" + ">");
    ...
    foreach (Int32 n in InputArray2) {
        Console.WriteLine("<H2 Title=" + "\"" + "pow_si(x, n); x={0}, n={1}" 
            + "\"" + ">", x, n);
        Double res01 = math53.pow_si(x, n);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.pow_si(x, n);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.pow_si(x, n);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.pow_si(x, n);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.pow_si(x, n);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.pow_si(x, n);
        Console.WriteLine(" oreal:  {0}", res06);

#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.pow_si(x, n);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.pow_si(x, n);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.pow_si(x, n);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.pow_si(x, n);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.pow_si(x, n);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.pow_si(x, n);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.pow_si(x, n);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.pow_si(x, n);
...
#region TestPowSiCplx

public static void TestPowSiCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestPowSiCplx" + "\"" + ">");
    ...
    Console.WriteLine("<H2 Title=" + "\"" + "pow_si(x, n); x={0}, n={1}" 
        + "\"" + ">", x, n);
        Complex res01 = cmath53.pow_si(x, n);
        Console.WriteLine("cmath53:  {0}", res01);
        SingleC res02 = scplx.pow_si(x, n);
        Console.WriteLine("  scplx:  {0}", res02);
        Complex res03 = dcplx.pow_si(x, n);
        Console.WriteLine("  dcplx:  {0}", res03);
        ExtendedC res04 = ecplx.pow_si(x, n);
        Console.WriteLine("  ecplx:  {0}", res04);
        QuadrupleC res05 = qcplx.pow_si(x, n);
        Console.WriteLine("  qcplx:  {0}", res05);
        OctupleC res06 = ocplx.pow_si(x, n);
        Console.WriteLine("  ocplx:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
//        MpfrC res07 = mcplx.pow_si(x, n);
//        Console.WriteLine("  mcplx:  {0}", res07);
        SingleC res08 = sflintc.pow_si(x, n);
        Console.WriteLine("sflintc:  {0}", res08);
        Complex res09 = dflintc.pow_si(x, n);
        Console.WriteLine("dflintc:  {0}", res09);
        ExtendedC res10 = eflintc.pow_si(x, n);
        Console.WriteLine("eflintc:  {0}", res10);
        QuadrupleC res11 = qflintc.pow_si(x, n);
        Console.WriteLine("qflintc:  {0}", res11);
        OctupleC res12 = oflintc.pow_si(x, n);
        Console.WriteLine("oflintc:  {0}", res12);
        MpfrC res13 = mflintc.pow_si(x, n);
        Console.WriteLine("mflintc:  {0}", res13);
//        ArbC res16 = aflintc.pow_si(x, n);
...
#region TestPowSiRealImag

public static void TestPowSiRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestPowSiRealImag" + "\"" + ">");
