...
AnyPtr Lib_Eigen_QReal_Init_Func(int32_t mpCat, int32_t numType)
{
...
void Lib_Eigen_QReal_Clear(int32_t mpCat, int32_t numType, AnyPtr x)
{
    mpNumMatrixPtr dummy = NULL;
    switch (mpCat) {
...
void Lib_Eigen_QReal_GetCoeff(ScalarResPtr result, long row, long col, mpNumMatrixPtr source)
{
...
void Lib_Eigen_QReal_SetCoeff(mpNumMatrixPtr result, ScalarResPtr source, long row, long col)
{
...
void Lib_Eigen_QReal_Cplx_GetCoeff2(ScalarResPtr result1, ScalarResPtr result2, long row, long col, mpNumMatrixPtr source)
{
...
void Lib_Eigen_QReal_Cplx_SetCoeff2(mpNumMatrixPtr result, ScalarPtr source1, ScalarPtr source2, long row, long col)
{
...
uint32_t Lib_Eigen_QReal_GetInfo(int32_t mpCat, int32_t numType, long what, mpNumMatrixPtr Matrix)
{
    long result = 0;
    switch (mpCat) {
    case mp_eigen:  /* eigen */
...
void Lib_Eigen_QReal_Get_Block(int32_t mpCat, int32_t numType, mpNumMatrixPtr result, long what, long i, long j, long p, long q, mpNumMatrixPtr source)
{
    switch (mpCat) {
    case mp_eigen:  /* eigen */
        {
...
void Lib_Eigen_QReal_Put_Block(int32_t mpCat, int32_t numType, mpNumMatrixPtr result, long what, long i, long j, long p, long q, mpNumMatrixPtr source)
{
    switch (mpCat) {
    case mp_eigen:  /* eigen */
        {
...
void Lib_Eigen_QReal_SetSpecialValue(int32_t mpCat, int32_t numType, mpNumMatrixPtr result, long what, long m, long n)
{
    switch (mpCat) {
    case mp_eigen:  /* eigen */
        {
...
void Lib_Eigen_QReal_SetSpecialValue2(int32_t mpCat, int32_t numType, mpNumMatrixPtr result, long what, long Vertical, long Horizontal, long PartialMode, mpNumMatrixPtr source)
{
    switch (mpCat) {
    case mp_eigen:  /* eigen */
        {
...
uint32_t Lib_Eigen_QReal_Compare(int32_t mpCat, int32_t numType, long what, mpNumMatrixPtr x, mpNumMatrixPtr y)
{
    long result;
    switch (mpCat) {
    case mp_eigen:  /* eigen */
...
void Lib_Eigen_QReal_ConvertRealCplx(mpNumMatrixPtr RMat, long what, mpNumMatrixPtr CMat)
{
...
void Lib_Eigen_QReal_Real_CplxScalarArithmetic(mpNumMatrixPtr result, long what, mpNumMatrixPtr x, ScalarPtr y_re, ScalarPtr y_im)
{
...
void Lib_Eigen_QReal_BasicArithmetic(int32_t mpCat, int32_t numType, mpNumMatrixPtr result, long what, mpNumMatrixPtr x, mpNumMatrixPtr y)
{
    switch (mpCat) {
    case mp_eigen:  /* eigen */
        {
...
void Lib_Eigen_QReal_Stats(int32_t mpCat, int32_t numType, mpNumMatrixPtr result, long what, long PartialMode, mpNumMatrixPtr source)
{
    switch (mpCat) {
    case mp_eigen:  /* eigen */
        {
...
void Lib_Eigen_QReal_Stats2(int32_t mpCat, int32_t numType, mpNumMatrixPtr result, long *IndexX, long *IndexY, long what, mpNumMatrixPtr source)
{
    switch (mpCat) {
    case mp_eigen:  /* eigen */
        {
...
void Lib_Eigen_QReal_Map_GetItemValue(int32_t mpCat, int32_t numType, mpNumMatrixPtr ptr, MapPtr names, char *s)
{
    switch (mpCat) {
    case mp_eigen:  /* eigen */
        {
...
void Lib_Eigen_QReal_MultipleResults(int32_t mpCat, int32_t numType, MapPtr z, int32_t what, char *s, mpNumMatrixPtr A, mpNumMatrixPtr b)
{
    switch (mpCat) {
    case mp_eigen:  /* eigen */
        {
...
void Lib_Eigen_QReal_Sort(int32_t numType, mpNumMatrixPtr x, int32_t SortOrder, int32_t SortCriterion)
{
    switch (numType) {
...
void Lib_Eigen_QReal_SortRowsByColumn(int32_t numType, mpNumMatrixPtr A, int32_t ColumnToSortBy, int32_t SortOrder, int32_t SortCriterion)
{
    switch (numType) {
...
void Lib_Eigen_QReal_Select_Rows(int32_t numType, mpNumMatrixPtr res, mpNumMatrixPtr A)
{
    switch (numType) {
...
void Lib_Eigen_QReal_Real_Roots_To_MonicPolynomial(mpNumMatrixPtr polynomial_result, mpNumMatrixPtr roots_source)
{
...
void Lib_Eigen_QReal_Real_Poly_Eval(mpNumMatrixPtr evaluation_result, mpNumMatrixPtr polynomial_source, mpNumMatrixPtr roots_source)
{
...
void Lib_Eigen_QReal_Real_Poly_Eval_Complex(mpNumMatrixPtr evaluation_result, mpNumMatrixPtr polynomial_source, mpNumMatrixPtr cplxroots_source)
{
...
void Lib_Eigen_QReal_Real_PolynomialSolver(mpNumMatrixPtr cplxroots_result, mpNumMatrixPtr polynomial_source)
{
...
void Lib_Eigen_QReal_Cplx_Roots_To_MonicPolynomial(mpNumMatrixPtr polynomial_result, mpNumMatrixPtr roots_source)
{
    EigenLib_cplx_mpType_Roots_To_MonicPolynomial((mpCplxMatrixPtr) polynomial_result, (mpCplxMatrixPtr) roots_source);
}


void Lib_Eigen_QReal_Cplx_Poly_Eval_Complex(mpNumMatrixPtr evaluation_result, mpNumMatrixPtr polynomial_source, mpNumMatrixPtr roots_source)
{
...
void Lib_Eigen_QReal_Cplx_PolynomialSolver(mpNumMatrixPtr cplxroots_result, mpNumMatrixPtr polynomial_source)
{
...
void Lib_Eigen_QReal_Cplx_FFT_Fwd(mpNumMatrixPtr result, mpNumMatrixPtr source)
{
    EigenLib_cplx_mpType_FFT_fwd((mpCplxMatrixPtr) result, (mpCplxMatrixPtr) source);
}


void Lib_Eigen_QReal_Cplx_FFT_Inv(mpNumMatrixPtr result, mpNumMatrixPtr source)
{
...
void Lib_Eigen_QReal_Real_FFT_Real_Fwd(mpNumMatrixPtr result, mpNumMatrixPtr source)
{
    EigenLib_mpType_FFT_real_fwd((mpCplxMatrixPtr) result, (mpMatrixPtr) source);
}


void Lib_Eigen_QReal_Real_FFT_Real_Inv(mpNumMatrixPtr result, mpNumMatrixPtr source)
{
...
//
//
//void Lib_Eigen_QReal_Real_MatrixFunction(mpNumMatrixPtr result, long what, mpNumMatrixPtr A)
//{
...
//
//
//void Lib_Eigen_QReal_Cplx_MatrixFunction(mpNumMatrixPtr result, long what, mpNumMatrixPtr A)
//{
...
void Lib_Eigen_QReal_Real_testHybrj_ext(FuncPtr f1, FuncPtr f2, mpNumMatrixPtr matX_, mpNumMatrixPtr matFvec_, mpNumMatrixPtr matFjac_, mpNumMatrixPtr matInput)
{
...
void Lib_Eigen_QReal_Real_testLmder_ext(FuncPtr f1, FuncPtr f2, mpNumMatrixPtr matX_, mpNumMatrixPtr matFvec_, mpNumMatrixPtr matFjac_, mpNumMatrixPtr matInput)
{
...
void Lib_Eigen_QReal_Real_CppOptLib1(int32_t what, FuncPtr f1, mpNumMatrixPtr matX_, mpNumMatrixPtr matNorm_, mpNumMatrixPtr xPtr, mpNumMatrixPtr resPtr)
{
...
void Lib_Eigen_QReal_Real_CppOptLib2(int32_t what, FuncPtr f1, FuncPtr f2, mpNumMatrixPtr matX_, mpNumMatrixPtr matGrad_, mpNumMatrixPtr matNorm_, mpNumMatrixPtr xPtr, mpNumMatrixPtr resPtr)
{
...
void Lib_Eigen_QReal_Real_CppOptLib3(int32_t what, FuncPtr f1, FuncPtr f2, FuncPtr f3, mpNumMatrixPtr matX_, mpNumMatrixPtr matHessian_, mpNumMatrixPtr matGrad_, mpNumMatrixPtr matNorm_, mpNumMatrixPtr xPtr, mpNumMatrixPtr resPtr)
{
...
mpNumMatrixPtr Lib_EigenSparse_QReal_Init_Func()
{
    mpNumMatrixPtr dummy = NULL;
...
void Lib_EigenSparse_QReal_Clear(mpNumMatrixPtr x)
{
    EigenSparseLib_mpType_Clear((mpSparseMatrixPtr) x);
}


uint32_t Lib_EigenSparse_QReal_GetInfo(long what, mpNumMatrixPtr SparseMatrix)
{
     long result;
...
void Lib_EigenSparse_QReal_Get_Block(mpNumMatrixPtr result, long what, long i, long j, long p, long q, mpNumMatrixPtr source)
{
    EigenSparseLib_mpType_GetBlock((mpSparseMatrixPtr) result, what, i, j, p, q, (mpSparseMatrixPtr) source);
}


void Lib_EigenSparse_QReal_Put_Block(mpNumMatrixPtr result, long what, long i, long j, long p, long q, mpNumMatrixPtr source)
{
...
void Lib_EigenSparse_QReal_SetSpecialValue(mpNumMatrixPtr xPtr, long what, long m, long n)
{
...
void Lib_EigenSparse_QReal_SetSpecialValue2(mpNumMatrixPtr result, long what, long Vertical, long Horizontal, long PartialMode, mpNumMatrixPtr source)
{
...
void Lib_EigenSparse_QReal_BasicArithmetic(mpNumMatrixPtr result, long what, mpNumMatrixPtr x, mpNumMatrixPtr y)
{
...
void Lib_EigenSparse_QReal_Stats(mpNumMatrixPtr result, long what, long PartialMode, mpNumMatrixPtr source)
{
...
void EigenSparseLib_QReal_DenseFromSparse(mpNumMatrixPtr result, mpNumMatrixPtr source)
{
    EigenSparseLib_mpType_DenseFromSparse((mpMatrixPtr) result, (mpSparseMatrixPtr) source);
}


void EigenSparseLib_QReal_SparseFromDense(mpNumMatrixPtr result, mpNumMatrixPtr source)
{
    EigenSparseLib_mpType_SparseFromDense((mpSparseMatrixPtr) result, (mpMatrixPtr) source);
}


void EigenSparseLib_QReal_Solve(mpNumMatrixPtr x, mpNumMatrixPtr A, mpNumMatrixPtr b, long Decomposition)
{
...
void Lib_QReal_PrintSparseMatrix(mpNumMatrixPtr M)
{
...
mpNumMatrixPtr Lib_EigenSparse_QReal_Cplx_Init_Func()
{
    mpNumMatrixPtr dummy = NULL;
...
void Lib_EigenSparse_QReal_Cplx_Clear(mpNumMatrixPtr x)
{
    EigenSparseLib_cplx_mpType_Clear((mpCplxSparseMatrixPtr) x);
}


uint32_t Lib_EigenSparse_QReal_Cplx_GetInfo(long what, mpNumMatrixPtr SparseMatrix)
{
     long result;
...
void Lib_EigenSparse_QReal_Cplx_Get_Block(mpNumMatrixPtr result, long what, long i, long j, long p, long q, mpNumMatrixPtr source)
{
    EigenSparseLib_cplx_mpType_GetBlock((mpCplxSparseMatrixPtr) result, what, i, j, p, q, (mpCplxSparseMatrixPtr) source);
}


void Lib_EigenSparse_QReal_Cplx_Put_Block(mpNumMatrixPtr result, long what, long i, long j, long p, long q, mpNumMatrixPtr source)
{
...
void Lib_EigenSparse_QReal_Cplx_SetSpecialValue(mpNumMatrixPtr xPtr, long what, long m, long n)
{
...
void Lib_EigenSparse_QReal_Cplx_SetSpecialValue2(mpNumMatrixPtr result, long what, long Vertical, long Horizontal, long PartialMode, mpNumMatrixPtr source)
{
...
void Lib_EigenSparse_QReal_Cplx_BasicArithmetic(mpNumMatrixPtr result, long what, mpNumMatrixPtr x, mpNumMatrixPtr y)
{
...
void EigenSparseLib_QReal_Cplx_DenseFromSparse(mpNumMatrixPtr result, mpNumMatrixPtr source)
{
    EigenSparseLib_cplx_mpType_DenseFromSparse((mpCplxMatrixPtr) result, (mpCplxSparseMatrixPtr) source);
}


void EigenSparseLib_QReal_Cplx_SparseFromDense(mpNumMatrixPtr result, mpNumMatrixPtr source)
{
...
void EigenSparseLib_QReal_Cplx_Solve(mpNumMatrixPtr x, mpNumMatrixPtr A, mpNumMatrixPtr b, long Decomposition)
{
