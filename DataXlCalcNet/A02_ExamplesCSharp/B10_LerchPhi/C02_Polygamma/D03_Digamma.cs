...
#region TestDigammaReal

public static void TestDigammaReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestDigammaReal" + "\"" + ">");
    double[] InputArray1 = { -0.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "digamma(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.digamma(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.digamma(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.digamma(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.digamma(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.digamma(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.digamma(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.digamma(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.digamma(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.digamma(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.digamma(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.digamma(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.digamma(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.digamma(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.digamma(x);
...
#region TestDigammaCplx

public static void TestDigammaCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestDigammaCplx" + "\"" + ">");
    ...
    foreach (var x in InputArray1C) {
        Console.WriteLine("<H2 Title=" + "\"" + "digamma(x); " + "x={0}" + 
            "\"" + ">", x);
        Complex res01 = cmath53.digamma(x);
        Console.WriteLine("cmath53:  {0}", res01);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        SingleC res08 = sflintc.digamma(x);
        Console.WriteLine("sflintc:  {0}", res08);
        Complex res09 = dflintc.digamma(x);
        Console.WriteLine("dflintc:  {0}", res09);
        ExtendedC res10 = eflintc.digamma(x);
        Console.WriteLine("eflintc:  {0}", res10);
        QuadrupleC res11 = qflintc.digamma(x);
        Console.WriteLine("qflintc:  {0}", res11);
        OctupleC res12 = oflintc.digamma(x);
        Console.WriteLine("oflintc:  {0}", res12);
        MpfrC res13 = mflintc.digamma(x);
        Console.WriteLine("mflintc:  {0}", res13);
        ArbC res16 = aflintc.digamma(x);
...
#region TestDigammaRealImag

public static void TestDigammaRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestDigammaRealImag" + 
        "\"" + ">");
