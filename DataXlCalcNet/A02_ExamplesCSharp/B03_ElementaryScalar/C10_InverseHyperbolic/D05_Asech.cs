...
#region TestAsechReal

public static void TestAsechReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAsechReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "asech(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.asech(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.asech(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.asech(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.asech(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.asech(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.asech(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.asech(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.asech(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.asech(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.asech(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.asech(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.asech(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.asech(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.asech(x);
...
#region TestAsechCplx

public static void TestAsechCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAsechCplx" + "\"" + ">");
...
#region TestAsechRealImag

public static void TestAsechRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAsechRealImag" + 
        "\"" + ">");
