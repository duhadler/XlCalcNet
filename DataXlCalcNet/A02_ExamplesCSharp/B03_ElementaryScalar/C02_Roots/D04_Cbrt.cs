...
public static void TestCbrtCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCbrtCplx" + "\"" + ">");
...
#region TestCbrtRealImag

public static void TestCbrtRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCbrtRealImag" + 
        "\"" + ">");
