...
namespace NewDistrib
{
    ...
    static class DistMCP2
    {
        ...
        public static void demoMCP2()
        {
            ...
            result = SMM1dis(m, n, X, ref LeftTail, ref RightTail);
            Console.WriteLine("result, SMM1: {0}", result);
            result = Dunnett1dis(m, n, X, ref LeftTail, ref RightTail);
            Console.WriteLine("result, DUN1: {0}", result);
            result = DistN.tdisn(n, X, d, ref LeftTail, ref RightTail);
            Console.WriteLine("result, TDIS:  {0}", result);
