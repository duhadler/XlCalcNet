...
public static void TestCothCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCothCplx" + "\"" + ">");
...
#region TestCothRealImag

public static void TestCothRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCothRealImag" + 
        "\"" + ">");
