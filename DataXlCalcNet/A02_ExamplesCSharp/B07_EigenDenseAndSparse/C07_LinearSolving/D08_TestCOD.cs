...
public static void DemoAnyMatCODCtx()
{
    ...
    var res = A.COD("info, dimofkernel, rank, nonzeropivots, isinjective, " + 
        "isinvertible, issurjective, absdet, logabsdet, maxpivot, qtz, t, " + 
        "z, householderq, hqnonzeros, x, pseudoinverse", b1);
