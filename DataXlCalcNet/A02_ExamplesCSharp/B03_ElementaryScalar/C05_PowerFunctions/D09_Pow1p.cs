...
#region TestPow1pReal

public static void TestPow1pReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestPow1pReal" + "\"" + ">");
...
//    Double[] InputArray2 = { -4.333, 0.0, 4.333 };
    ...
    foreach (Double y in InputArray2) {
        Console.WriteLine("<H2 Title=" + "\"" + "pow1p(x, y); x={0}, y={1}" 
            + "\"" + ">", x, y);
        Double res01 = math53.pow1p(x, y);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.pow1p(x, y);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.pow1p(x, y);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.pow1p(x, y);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.pow1p(x, y);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.pow1p(x, y);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.pow1p(x, y);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.pow1p(x, y);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.pow1p(x, y);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.pow1p(x, y);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.pow1p(x, y);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.pow1p(x, y);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.pow1p(x, y);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.pow1p(x, y);
...
#region TestPow1pCplx

public static void TestPow1pCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestPow1pCplx" + "\"" + ">");
    ...
    foreach (Complex y in InputArray2C) {
        Console.WriteLine("<H2 Title=" + "\"" + "pow1p(x, y); x={0}, y={1}" 
        + "\"" + ">", x, y);
        Complex res01 = cmath53.pow1p(x, y);
        Console.WriteLine("cmath53:  {0}", res01);
        SingleC res02 = scplx.pow1p(x, y);
        Console.WriteLine("  scplx:  {0}", res02);
        Complex res03 = dcplx.pow1p(x, y);
        Console.WriteLine("  dcplx:  {0}", res03);
        ExtendedC res04 = ecplx.pow1p(x, y);
        Console.WriteLine("  ecplx:  {0}", res04);
        QuadrupleC res05 = qcplx.pow1p(x, y);
        Console.WriteLine("  qcplx:  {0}", res05);
        OctupleC res06 = ocplx.pow1p(x, y);
        Console.WriteLine("  ocplx:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        MpfrC res07 = mcplx.pow1p(x, y);
        Console.WriteLine("  mcplx:  {0}", res07);
        SingleC res08 = sflintc.pow1p(x, y);
        Console.WriteLine("sflintc:  {0}", res08);
        Complex res09 = dflintc.pow1p(x, y);
        Console.WriteLine("dflintc:  {0}", res09);
        ExtendedC res10 = eflintc.pow1p(x, y);
        Console.WriteLine("eflintc:  {0}", res10);
        QuadrupleC res11 = qflintc.pow1p(x, y);
        Console.WriteLine("qflintc:  {0}", res11);
        OctupleC res12 = oflintc.pow1p(x, y);
        Console.WriteLine("oflintc:  {0}", res12);
        MpfrC res13 = mflintc.pow1p(x, y);
        Console.WriteLine("mflintc:  {0}", res13);
        ArbC res16 = aflintc.pow1p(x, y);
...
#region TestPow1pRealImag

public static void TestPow1pRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestPow1pRealImag" + "\"" + ">");
