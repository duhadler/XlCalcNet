...
#region DemoAnyMatColPivHouseholderQRCtx
...
public static void DemoAnyMatColPivHouseholderQRCtx()
{
    ...
    var res = A.ColPivHouseholderQR("info, dimofkernel, rank, nonzeropivots," +
        " isinjective, isinvertible, issurjective, absdet, logabsdet," + 
        " maxpivot, qr, r, householderq, hqnonzeros, permcols, x, inverse", b1);
