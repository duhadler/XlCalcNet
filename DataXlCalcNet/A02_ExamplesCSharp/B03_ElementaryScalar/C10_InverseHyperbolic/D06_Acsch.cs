...
#region TestAcschReal

public static void TestAcschReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcschReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "acsch(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.acsch(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.acsch(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.acsch(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.acsch(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.acsch(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.acsch(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.acsch(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.acsch(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.acsch(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.acsch(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.acsch(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.acsch(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.acsch(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.acsch(x);
...
#region TestAcschCplx

public static void TestAcschCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcschCplx" + "\"" + ">");
...
#region TestAcschRealImag

public static void TestAcschRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcschRealImag" + 
        "\"" + ">");
