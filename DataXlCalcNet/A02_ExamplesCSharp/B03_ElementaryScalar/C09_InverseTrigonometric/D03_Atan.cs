...
public static void TestAtanCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAtanCplx" + "\"" + ">");
...
#region TestAtanRealImag

public static void TestAtanRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAtanRealImag" + 
        "\"" + ">");
