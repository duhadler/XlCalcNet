...
# End of standard key word arguments
    ...
    #USE_COLORS = False # True

    USE_COLORS = kwargs['UseColors'] if 'UseColors' in kwargs else False
    ChargePositionModel = kwargs['Model'] if 'UseColors' in kwargs else 1

    #ChargePositionModel = 1   # 1, 2, 3, 4
...
try:
    if __name__ == '__main__':
        ColoredFieldLines(UseColors=True, Model=1)
