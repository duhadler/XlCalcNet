...
public static void TestCoshCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCoshCplx" + "\"" + ">");
...
#region TestCoshRealImag

public static void TestCoshRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCoshRealImag" + 
        "\"" + ">");
