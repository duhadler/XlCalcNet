...
public static void TestAsinCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAsinCplx" + "\"" + ">");
...
#region TestAsinRealImag

public static void TestAsinRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAsinRealImag" + 
        "\"" + ">");
