...
namespace FlexDlgUserCtrl
{
    ...
    public partial class FlexDlgUserControl1 : UserControl
    {
        ...
        public void InitTextData()
        {
            ...
            TextDataScintilla.Dock = DockStyle.Fill;
            ...
            //this.tableLayoutPanelViewer.Controls.Add(TextDataScintilla, 1, 0);
            tabOutput.Controls.Add(TextDataScintilla);

            TextDataScintilla.ContextMenuStrip = contextMenuStripTextData;
            TextDataScintilla.ViewWhitespace = WhitespaceMode.VisibleAlways;
            TextDataScintilla.VirtualSpaceOptions = VirtualSpace.RectangularSelection;
            TextDataScintilla.WrapVisualFlags = ((WrapVisualFlags)(((WrapVisualFlags.End | WrapVisualFlags.Start)
        ...
        private void InitTextDataSyntaxColoring()
        {
            ...
            TextDataScintilla.SelectionBackColor = Color.LightBlue;
            TextDataScintilla.SelectionInactiveBackColor = Color.LightGray;
            ...
            TextDataScintilla.Styles[Style.Xml.DoubleString].ForeColor = Color.DarkGreen;
        ...
        private void collapseAllFoldToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int mylinecount = TextDataScintilla.Lines.Count - 1;
            for (int i = mylinecount; i >= 0; i--)
            {
                string curline = TextDataScintilla.Lines[i].Text;
                if (curline.StartsWith("<H"))
                {
                    TextDataScintilla.Lines[i].FoldLine(FoldAction.Contract);
                }
            }
        ...
        {
            TextDataScintilla.FoldAll(FoldAction.Expand);
        }
