...
public static void TestSqrtCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSqrtCplx" + "\"" + ">");
...
#region TestSqrtRealImag

public static void TestSqrtRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSqrtRealImag" 
        + "\"" + ">");
