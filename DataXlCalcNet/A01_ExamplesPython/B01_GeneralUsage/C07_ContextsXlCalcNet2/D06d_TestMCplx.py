...
import math
from xlcalcnet import ArbPrec, mreal, mcplx
...
def main_tests():
    ...
    arithmetic_operators_with_mcplx()
    ...
    arithmetic_comparisons_with_mcplx()
...
def general_assignments():
    ...
    z = mcplx.t("3", "4")
    print('z = mcplx.t("3", "4"):', z)
    z = mcplx.t(3.0, 4.0)
    print('z = mcplx.t(3.0, 4.0):', z)
    z = mcplx.t(3, 4)
    print('z = mcplx.t(3, 4):', z)
    z = mcplx.t(3+4j)
    print('z = mcplx.t(3+4j):', z)
    c = complex(3,4)
    print('c = complex(3,4):', c)
    z = mcplx.t(c)
    print('z = mcplx.t(c):', z)
    z = mcplx.t(1j)
    print('z = mcplx.t(1j):', z)
    z = mcplx.t(1)
    print('z = mcplx.t(1):', z)
    z = mcplx.t(1.1)
    print('z = mcplx.t(1.1):', z)
    print('</H1>')
...
def functions_with_argument_conversion():
    ...
    print('z = mcplx.t(3+4j):', z)
    z = mcplx.exp(z)
    print('z = mcplx.exp(z):', z)
    z = mcplx.exp(3+4j)
    print('z = mcplx.exp(3+4j):', z)
    z = mcplx.exp(5)
    print('z = mcplx.exp(5):', z)
    print('</H1>')


def arithmetic_operators_with_mcplx():
    print()
    print('<H1 Title="Arithmetic operators with mcplx">')
    z = mcplx.t(5.7, 6.3)
    print('z = mcplx.t(5.7, 6.3):', z)
    x = mcplx.t(3.9, 7.8)
    print('x = mcplx.t(3.9, 7.8):', x)
    y = x + z
    print('y = x + z:', y)
    y = z + x
    print('y = z + x:', y)
...
def arithmetic_comparisons_with_mcplx():
    print()
    print('<H1 Title="Arithmetic comparisons with mcplx">')
