...
MPNUMC_DLL_IMPORTEXPORT void __cdecl  Lib_Eigen_XReal_Real_CppOptLib1(int32_t what, FuncPtr f1, mpNumMatrixPtr matX_, mpNumMatrixPtr matNorm_, mpNumMatrixPtr xPtr, mpNumMatrixPtr resPtr);

MPNUMC_DLL_IMPORTEXPORT void __cdecl  Lib_Eigen_XReal_Real_CppOptLib2(int32_t what, FuncPtr f1, FuncPtr f2, mpNumMatrixPtr matX_, mpNumMatrixPtr matGrad_, mpNumMatrixPtr matNorm_, mpNumMatrixPtr xPtr, mpNumMatrixPtr resPtr);

MPNUMC_DLL_IMPORTEXPORT void __cdecl  Lib_Eigen_XReal_Real_CppOptLib3(int32_t what, FuncPtr f1, FuncPtr f2, FuncPtr f3, mpNumMatrixPtr matX_, mpNumMatrixPtr matHessian_, mpNumMatrixPtr matGrad_, mpNumMatrixPtr matNorm_, mpNumMatrixPtr xPtr, mpNumMatrixPtr resPtr);//




//MPNUMC_DLL_IMPORTEXPORT void __cdecl  Lib_Eigen_XReal_Real_demoLinearRegression();
//MPNUMC_DLL_IMPORTEXPORT void __cdecl  Lib_Eigen_XReal_Real_demoLogisticRegression();
