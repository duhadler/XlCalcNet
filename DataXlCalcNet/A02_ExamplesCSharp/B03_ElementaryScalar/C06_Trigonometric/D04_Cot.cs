...
public static void TestCotCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCotCplx" + "\"" + ">");
...
#region TestCotRealImag

public static void TestCotRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCotRealImag" + 
        "\"" + ">");
