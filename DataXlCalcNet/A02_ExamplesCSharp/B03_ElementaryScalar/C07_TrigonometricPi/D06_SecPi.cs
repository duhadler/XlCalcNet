...
#region TestSecpiReal

public static void TestSecpiReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSecpiReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "secpi(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.secpi(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.secpi(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.secpi(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.secpi(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.secpi(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.secpi(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.secpi(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.secpi(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.secpi(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.secpi(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.secpi(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.secpi(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.secpi(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.secpi(x);
...
#region TestSecpiCplx

public static void TestSecpiCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSecpiCplx" + "\"" + ">");
...
#region TestSecpiRealImag

public static void TestSecpiRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSecpiRealImag" + 
        "\"" + ">");
