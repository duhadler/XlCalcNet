...
#region TestRootSiReal

public static void TestRootSiReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestRootSiReal" + "\"" + ">");
    ...
    foreach (Int32 n in InputArray2) {
        Console.WriteLine("<H2 Title=" + "\"" + "root_si(x, n); x={0}, n={1}" 
            + "\"" + ">", x, n);
        Double res01 = math53.root_si(x, n);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.root_si(x, n);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.root_si(x, n);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.root_si(x, n);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.root_si(x, n);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.root_si(x, n);
        Console.WriteLine(" oreal:  {0}", res06);

#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.root_si(x, n);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.root_si(x, n);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.root_si(x, n);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.root_si(x, n);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.root_si(x, n);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.root_si(x, n);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.root_si(x, n);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.root_si(x, n);
...
#region TestRootSiCplx

public static void TestRootSiCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestRootSiCplx" + "\"" + ">");
    ...
    Console.WriteLine("<H2 Title=" + "\"" + "root_si(x, n); x={0}, n={1}" 
        + "\"" + ">", x, n);
        Complex res01 = cmath53.root_si(x, n);
        Console.WriteLine("cmath53:  {0}", res01);
        SingleC res02 = scplx.root_si(x, n);
        Console.WriteLine("  scplx:  {0}", res02);
        Complex res03 = dcplx.root_si(x, n);
        Console.WriteLine("  dcplx:  {0}", res03);
        ExtendedC res04 = ecplx.root_si(x, n);
        Console.WriteLine("  ecplx:  {0}", res04);
        QuadrupleC res05 = qcplx.root_si(x, n);
        Console.WriteLine("  qcplx:  {0}", res05);
        OctupleC res06 = ocplx.root_si(x, n);
        Console.WriteLine("  ocplx:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        MpfrC res07 = mcplx.root_si(x, n);
        Console.WriteLine("  mcplx:  {0}", res07);
        SingleC res08 = sflintc.root_si(x, n);
        Console.WriteLine("sflintc:  {0}", res08);
        Complex res09 = dflintc.root_si(x, n);
        Console.WriteLine("dflintc:  {0}", res09);
        ExtendedC res10 = eflintc.root_si(x, n);
        Console.WriteLine("eflintc:  {0}", res10);
        QuadrupleC res11 = qflintc.root_si(x, n);
        Console.WriteLine("qflintc:  {0}", res11);
        OctupleC res12 = oflintc.root_si(x, n);
        Console.WriteLine("oflintc:  {0}", res12);
        MpfrC res13 = mflintc.root_si(x, n);
        Console.WriteLine("mflintc:  {0}", res13);
        ArbC res16 = aflintc.root_si(x, n);
...
#region TestRootSiRealImag

public static void TestRootSiRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestRootSiRealImag" + "\"" + ">");
