...
def MplOhclMav369VolNonTrad(**kwargs):
    OutputDir = kwargs['OutputDir'] if 'OutputDir' in kwargs else 'OutputMonitor'
    Title = kwargs['Title'] if 'Title' in kwargs else 'MplOhclMav369VolNonTrad'
...
# End of custom key word arguments
    ...
    fig, axlist = mpf.plot(daily, type='candle', mav=(3,6,9), volume=True, 
