...
def general_assignments():
    ...
    x = dpm.t(5.7)
    print('x = dpm.t(5.7):', x)
    x0 = dpm.t(2329456398453948563945639364827346)
    print('x0 = dpm.t(2329456398453948563945639364827346', x0)
    x1 = dpm.t("2329456398453948563945639364827346")
    print('x1 = dpm.t("2329456398453948563945639364827346"):', x1)
    x = dpm.t("5.5")
    print('x = dpm.t("5.5"):', x)
...
def functions_with_argument_conversion():
    ...
    z = dpm.exp(dec)
    print('z = dpm.exp(dec):', z)
#    frac = Fraction("-3/7")
#    print('frac = Fraction("-3/7:")', frac)
#    z = dpm.exp(frac)
#    print('z = dpm.exp(frac):', z)
    ...
    print('y = dpm.t(33):', y)
    z = dpm.pow(x, y)
    print('z = dpm.pow(x, y):        ', z)
    z = dpm.pow(5.5, 3.3)
    print('z = dpm.pow(5.5, 3.3):    ', z)
    z = dpm.pow("5.5", "3.3")
    print('z = dpm.pow("5.5", "3.3"):', z)
    z = dpm.pow(5, 3)
    print('z = dpm.pow(5, 3):', z)
...
#    xMat = dpm.Mat.Random(2,2)
#    print('xMat = dpm.Mat.Random(2,2): \n', xMat)
#
#    xcoeff = dpm.t(4.5)
#    print('xcoeff = dpm.t(4.5): ', xcoeff)
#
#    xMat[1,1] = xcoeff
