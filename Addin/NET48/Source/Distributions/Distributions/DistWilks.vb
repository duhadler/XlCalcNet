...
Module DistWilks
    ...
    Sub BetaflintodDis2(p As Integer, b() As Double, c() As Double, x As Double,
        ...
        Righttail = dreal.dist_beta(v1, df2).cdf(1 - x)
    ...
    '{Approximation by Nagarsenker}
    Function BetaflintodDisX2(LeftTail As Double, Righttail As Double, p As Integer, b() As Double, c() As Double) As Double
        Dim i As Integer
    ...
    Function GammaP(p As Long, x As Double) As Double
        Const pi = 3.14159265358979
        Dim i As Long, prod As Double, k As Double
        prod = 1
        For i = 1 To p
            prod = prod * dreal.real_gamma(x - 0.5 * (i - 1))
    ...
    Function LnGammaP(p As Long, x As Double) As Double
        Const pi = 3.14159265358979
        Dim i As Long, sum As Double, k As Double
        sum = 0
        For i = 1 To p
    ...
    Sub TestGammaP()
        Dim p As Long, x As Double, Result As Double
        p = 1
        x = 14
        Result = LnGammaP(p, x)
    ...
    Function LnHypergeometric1F1Matrix(p As Long, a As Double, b As Double, x() As Double) As Double
        Dim k As Double, y() As Double, tau As Double
        Dim i As Long, j As Long, prod As Double, r11 As Double, Result As Double
    ...
    Sub TestHypergeometric1F1Matrix()
        Dim p As Long, a As Double, b As Double, x() As Double
        Dim Result As Double
        p = 2
        a = 61
        b = 2
    ...
    Sub TestHypergeometric0F1Matrix()
        Dim p As Long, n As Double, x() As Double
        Dim Result As Double
        p = 2
        n = 61
        ReDim x(p)
    ...
    Private Function B3(h As Double) As Double
    ...
    Sub WilksExact(p As Integer, f1 As Integer, f2 As Double, l As Double,
        ...
        Next i
        Call BetaflintodDis(p, b, c, l, LeftTail, Righttail)
    End Sub
    ...
    Sub BetaflintodDis(p As Integer, b() As Double, c() As Double, x As Double,
                          ByRef LeftTail As Double, ByRef Righttail As Double)
    ...
    Sub BetaflintodDis5(first As Boolean, odd_f1 As Boolean, p As Integer, b() As Double,
    ...
    Sub WilksExactN2(IsRho As Boolean, p As Integer, f1 As Integer, f2 As Double, l As Double,
     lambda As Double, LeftTail As Double, Righttail As Double)
        ...
        Call BetaflintodDis5(True, IsOdd_f1, p, b, c, l, LeftTail, Righttail)
        sum = LeftTail
        ...
        While RelError > 0.0000000000000001
            ...
            End If
            '{    BetaflintodDis2(p,b,c,L,LeftTail,RightTail)}
            Call BetaflintodDis5(False, IsOdd_f1, p, b, c, l, LeftTail, Righttail)
