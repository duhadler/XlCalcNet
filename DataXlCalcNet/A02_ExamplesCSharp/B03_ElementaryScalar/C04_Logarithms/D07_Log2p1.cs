...
#region TestLog2p1Real

public static void TestLog2p1Real()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLog2p1Real" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "log2p1(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.log2p1(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.log2p1(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.log2p1(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.log2p1(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.log2p1(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.log2p1(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.log2p1(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.log2p1(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.log2p1(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.log2p1(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.log2p1(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.log2p1(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.log2p1(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.log2p1(x);
...
#region TestLog2p1Cplx

public static void TestLog2p1Cplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLog2p1Cplx" + "\"" + ">");
...
#region TestLog2p1RealImag

public static void TestLog2p1RealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLog2p1RealImag" + 
        "\"" + ">");
