...
#region TestHardyZReal

public static void TestHardyZReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestHardyZReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var s in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "hardy_z(s); " + "s={0}" 
            + "\"" + ">", s);
        Double res01 = math53.hardy_z(s);
        Console.WriteLine("math53:  {0}", res01);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Single res08 = sflint.hardy_z(s);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.hardy_z(s);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.hardy_z(s);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.hardy_z(s);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.hardy_z(s);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.hardy_z(s);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.hardy_z(s);
...
#region TestHardyZCplx

public static void TestHardyZCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestHardyZCplx" + "\"" + ">");
    ...
    foreach (var s in InputArray1C) {
        Console.WriteLine("<H2 Title=" + "\"" + "hardy_z(s); " + "s={0}" + 
            "\"" + ">", s);
        Complex res01 = cmath53.hardy_z(s);
        Console.WriteLine("cmath53:  {0}", res01);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        SingleC res08 = sflintc.hardy_z(s);
        Console.WriteLine("sflintc:  {0}", res08);
        Complex res09 = dflintc.hardy_z(s);
        Console.WriteLine("dflintc:  {0}", res09);
        ExtendedC res10 = eflintc.hardy_z(s);
        Console.WriteLine("eflintc:  {0}", res10);
        QuadrupleC res11 = qflintc.hardy_z(s);
        Console.WriteLine("qflintc:  {0}", res11);
        OctupleC res12 = oflintc.hardy_z(s);
        Console.WriteLine("oflintc:  {0}", res12);
        MpfrC res13 = mflintc.hardy_z(s);
        Console.WriteLine("mflintc:  {0}", res13);
        ArbC res16 = aflintc.hardy_z(s);
...
#region TestHardyZRealImag

public static void TestHardyZRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestHardyZRealImag" + 
        "\"" + ">");
