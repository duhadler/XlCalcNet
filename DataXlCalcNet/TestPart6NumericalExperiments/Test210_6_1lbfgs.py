# See https://github.com/midori1/pylbfgs/blob/master/lbfgs.py

# See https://github.com/midori1/pylbfgs

# See http://www.chokkan.org/software/liblbfgs/index.html
...
class lbfgs:
	...
	def do_lbfgs(self):
		...
		lm = []
		for i in range(0, m):
			s = array([0.0 for i in range(self.n)])
			y = array([0.0 for i in range(self.n)])
