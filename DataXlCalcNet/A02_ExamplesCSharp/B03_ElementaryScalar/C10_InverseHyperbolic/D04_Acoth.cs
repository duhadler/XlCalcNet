...
#region TestAcothReal

public static void TestAcothReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcothReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "acoth(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.acoth(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.acoth(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.acoth(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.acoth(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.acoth(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.acoth(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.acoth(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.acoth(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.acoth(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.acoth(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.acoth(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.acoth(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.acoth(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.acoth(x);
...
#region TestAcothCplx

public static void TestAcothCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcothCplx" + "\"" + ">");
...
#region TestAcothRealImag

public static void TestAcothRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcothRealImag" + 
        "\"" + ">");
