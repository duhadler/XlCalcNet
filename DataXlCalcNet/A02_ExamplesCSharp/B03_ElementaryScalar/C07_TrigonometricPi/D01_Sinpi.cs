...
#region TestSinpiReal

public static void TestSinpiReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSinpiReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "sinpi(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.sinpi(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.sinpi(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.sinpi(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.sinpi(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.sinpi(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.sinpi(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.sinpi(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.sinpi(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.sinpi(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.sinpi(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.sinpi(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.sinpi(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.sinpi(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.sinpi(x);
...
#region TestSinpiCplx

public static void TestSinpiCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSinpiCplx" + "\"" + ">");
...
#region TestSinpiRealImag

public static void TestSinpiRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSinpiRealImag" + 
        "\"" + ">");
