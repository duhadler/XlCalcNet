...
#region TestCscpiReal

public static void TestCscpiReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCscpiReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "cscpi(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.cscpi(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.cscpi(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.cscpi(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.cscpi(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.cscpi(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.cscpi(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.cscpi(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.cscpi(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.cscpi(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.cscpi(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.cscpi(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.cscpi(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.cscpi(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.cscpi(x);
...
#region TestCscpiCplx

public static void TestCscpiCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCscpiCplx" + "\"" + ">");
...
#region TestCscpiRealImag

public static void TestCscpiRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCscpiRealImag" + 
        "\"" + ">");
