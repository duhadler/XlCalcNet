...
/* No syntax highlighting if HasArbPrecNet is undefined */
    ...
    TestFermiDiracReal();
    TestFermiDiracCplx();
    TestFermiDiracRealImag();
}


#region TestFermiDiracReal

public static void TestFermiDiracReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestFermiDiracReal" + "\"" + ">");
    ...
    foreach (Double z in InputArray2) {
        Console.WriteLine("<H2 Title=" + "\"" + "fermi_dirac(s, z); s={0}, z={1}" 
            + "\"" + ">", s, z);
        Double res01 = math53.fermi_dirac(s, z);
        Console.WriteLine("math53:  {0}", res01);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Single res08 = sflint.fermi_dirac(s, z);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.fermi_dirac(s, z);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.fermi_dirac(s, z);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.fermi_dirac(s, z);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.fermi_dirac(s, z);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.fermi_dirac(s, z);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.fermi_dirac(s, z);
...
#region TestFermiDiracCplx

public static void TestFermiDiracCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestFermiDiracCplx" + "\"" + ">");
    ...
    foreach (Complex z in InputArray2C) {
        Console.WriteLine("<H2 Title=" + "\"" + "fermi_dirac(s, z); s={0}, z={1}" 
        + "\"" + ">", s, z);
        Complex res01 = cmath53.fermi_dirac(s, z);
        Console.WriteLine("cmath53:  {0}", res01);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        SingleC res08 = sflintc.fermi_dirac(s, z);
        Console.WriteLine("sflintc:  {0}", res08);
        Complex res09 = dflintc.fermi_dirac(s, z);
        Console.WriteLine("dflintc:  {0}", res09);
        ExtendedC res10 = eflintc.fermi_dirac(s, z);
        Console.WriteLine("eflintc:  {0}", res10);
        QuadrupleC res11 = qflintc.fermi_dirac(s, z);
        Console.WriteLine("qflintc:  {0}", res11);
        OctupleC res12 = oflintc.fermi_dirac(s, z);
        Console.WriteLine("oflintc:  {0}", res12);
        MpfrC res13 = mflintc.fermi_dirac(s, z);
        Console.WriteLine("mflintc:  {0}", res13);
        ArbC res16 = aflintc.fermi_dirac(s, z);
...
#region TestFermiDiracRealImag

public static void TestFermiDiracRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestFermiDiracRealImag" + "\"" + ">");
    ...
    foreach (var IsReal in ReImArray) {
        ...
        Console.WriteLine("<H2 Title=" + "\"" + ReIm + "fermi_dirac(s, z)); s={0}, z={1}" 
            + "\"" + ">", s, z);

        Complex res01c = cmath53.fermi_dirac(s, z);
        Double res01 = IsReal ? res01c.Real : res01c.Imaginary;
        Console.WriteLine("cmath53:  {0}", res01);

#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        SingleC res08c = sflintc.fermi_dirac(s, z);
        Single res08 = IsReal ? res08c.real : res08c.imag;
        Console.WriteLine("sflintc:  {0}", res08);

        Complex res09c = dflintc.fermi_dirac(s, z);
        Double res09 = IsReal ? res09c.Real : res09c.Imaginary;
        Console.WriteLine("dflintc:  {0}", res09);

        ExtendedC res10c = eflintc.fermi_dirac(s, z);
        Extended res10 = IsReal ? res10c.real : res10c.imag;
        Console.WriteLine("eflintc:  {0}", res10);

        QuadrupleC res11c = qflintc.fermi_dirac(s, z);
        Quadruple res11 = IsReal ? res11c.real : res11c.imag;
        Console.WriteLine("qflintc:  {0}", res11);

        OctupleC res12c = oflintc.fermi_dirac(s, z);
        Octuple res12 = IsReal ? res12c.real : res12c.imag;
        Console.WriteLine("oflintc:  {0}", res12);

        MpfrC res13c = mflintc.fermi_dirac(s, z);
        Mpfr res13 = IsReal ? res13c.real : res13c.imag;
        Console.WriteLine("mflintc:  {0}", res13);

        ArbC res16c = aflintc.fermi_dirac(s, z);
