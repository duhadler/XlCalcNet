...
import math
from xlcalcnet import sreal, scplx
...
def main_tests():
    ...
    arithmetic_operators_with_scplx()
    ...
    arithmetic_comparisons_with_scplx()
...
def general_assignments():
    ...
    z = scplx.t("3", "4")
    print('z = scplx.t("3", "4"):', z)
    z = scplx.t(3.0, 4.0)
    print('z = scplx.t(3.0, 4.0):', z)
    z = scplx.t(3, 4)
    print('z = scplx.t(3, 4):', z)
    z = scplx.t(3+4j)
    print('z = scplx.t(3+4j):', z)
    c = complex(3,4)
    print('c = complex(3,4):', c)
    z = scplx.t(c)
    print('z = scplx.t(c):', z)
    z = scplx.t(1j)
    print('z = scplx.t(1j):', z)
    z = scplx.t(1)
    print('z = scplx.t(1):', z)
    z = scplx.t(1.1)
    print('z = scplx.t(1.1):', z)
    print('</H1>')
...
def functions_with_argument_conversion():
    ...
    print('z = scplx.t(3+4j):', z)
    z = scplx.exp(z)
    print('z = scplx.exp(z):', z)
    z = scplx.exp(3+4j)
    print('z = scplx.exp(3+4j):', z)
    z = scplx.exp(5)
    print('z = scplx.exp(5):', z)
    print('</H1>')


def arithmetic_operators_with_scplx():
    print()
    print('<H1 Title="Arithmetic operators with scplx">')
    z = scplx.t(5.7, 6.3)
    print('z = scplx.t(5.7, 6.3):', z)
    x = scplx.t(3.9, 7.8)
    print('x = scplx.t(3.9, 7.8):', x)
    y = x + z
    print('y = x + z:', y)
    y = z + x
    print('y = z + x:', y)
...
def arithmetic_comparisons_with_scplx():
    print()
    print('<H1 Title="Arithmetic comparisons with scplx">')
