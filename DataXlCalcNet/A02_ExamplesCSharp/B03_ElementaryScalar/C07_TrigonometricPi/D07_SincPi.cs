...
#region TestSincpiReal

public static void TestSincpiReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSincpiReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "sincpi(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.sincpi(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.sincpi(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.sincpi(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.sincpi(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.sincpi(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.sincpi(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.sincpi(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.sincpi(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.sincpi(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.sincpi(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.sincpi(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.sincpi(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.sincpi(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.sincpi(x);
...
#region TestSincpiCplx

public static void TestSincpiCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSincpiCplx" + "\"" + ">");
...
#region TestSincpiRealImag

public static void TestSincpiRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSincpiRealImag" + 
        "\"" + ">");
