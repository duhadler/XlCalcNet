...
/* No syntax highlighting if HasArbPrecNet is undefined */
    ...
    TestSqrt1pm1Real();
    TestSqrt1pm1Cplx();
    TestSqrt1pm1RealImag();
}


#region TestSqrt1pm1Real

public static void TestSqrt1pm1Real()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSqrt1pm1Real" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "sqrt1pm1(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.sqrt1pm1(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.sqrt1pm1(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.sqrt1pm1(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.sqrt1pm1(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.sqrt1pm1(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.sqrt1pm1(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.sqrt1pm1(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.sqrt1pm1(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.sqrt1pm1(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.sqrt1pm1(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.sqrt1pm1(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.sqrt1pm1(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.sqrt1pm1(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.sqrt1pm1(x);
...
#region TestSqrt1pm1Cplx

public static void TestSqrt1pm1Cplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSqrt1pm1Cplx" + "\"" + ">");
    ...
    foreach (var x in InputArray1C) {
        Console.WriteLine("<H2 Title=" + "\"" + "sqrt1pm1(x); " + "x={0}" + 
            "\"" + ">", x);
        Complex res01 = cmath53.sqrt1pm1(x);
        Console.WriteLine("cmath53:  {0}", res01);
        SingleC res02 = scplx.sqrt1pm1(x);
        Console.WriteLine("  scplx:  {0}", res02);
        Complex res03 = dcplx.sqrt1pm1(x);
        Console.WriteLine("  dcplx:  {0}", res03);
        ExtendedC res04 = ecplx.sqrt1pm1(x);
        Console.WriteLine("  ecplx:  {0}", res04);
        QuadrupleC res05 = qcplx.sqrt1pm1(x);
        Console.WriteLine("  qcplx:  {0}", res05);
        OctupleC res06 = ocplx.sqrt1pm1(x);
        Console.WriteLine("  ocplx:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        MpfrC res07 = mcplx.sqrt1pm1(x);
        Console.WriteLine("  mcplx:  {0}", res07);
        SingleC res08 = sflintc.sqrt1pm1(x);
        Console.WriteLine("sflintc:  {0}", res08);
        Complex res09 = dflintc.sqrt1pm1(x);
        Console.WriteLine("dflintc:  {0}", res09);
        ExtendedC res10 = eflintc.sqrt1pm1(x);
        Console.WriteLine("eflintc:  {0}", res10);
        QuadrupleC res11 = qflintc.sqrt1pm1(x);
        Console.WriteLine("qflintc:  {0}", res11);
        OctupleC res12 = oflintc.sqrt1pm1(x);
        Console.WriteLine("oflintc:  {0}", res12);
        MpfrC res13 = mflintc.sqrt1pm1(x);
        Console.WriteLine("mflintc:  {0}", res13);
        ArbC res16 = aflintc.sqrt1pm1(x);
...
#region TestSqrt1pm1RealImag

public static void TestSqrt1pm1RealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSqrt1pm1RealImag" + 
        "\"" + ">");
