...
def Heatmap2(**kwargs):
    ...
    Title = kwargs['Title'] if 'Title' in kwargs else 'Heatmap2'
...
##        return f"{x:.2f}".replace("0.", ".").replace("1.00", "")
    ...
    annotate_heatmap(im, valfmt=matplotlib.ticker.FuncFormatter(func0), size=9, fontweight="bold", threshold=-1,
    ...
    annotate_heatmap(im, valfmt=matplotlib.ticker.FuncFormatter(func1), size=7)
