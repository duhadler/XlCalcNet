...
#region TestTanpiReal

public static void TestTanpiReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestTanpiReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "tanpi(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.tanpi(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.tanpi(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.tanpi(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.tanpi(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.tanpi(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.tanpi(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.tanpi(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.tanpi(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.tanpi(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.tanpi(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.tanpi(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.tanpi(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.tanpi(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.tanpi(x);
...
#region TestTanpiCplx

public static void TestTanpiCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestTanpiCplx" + "\"" + ">");
...
#region TestTanpiRealImag

public static void TestTanpiRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestTanpiRealImag" + 
        "\"" + ">");
