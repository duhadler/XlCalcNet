...
public static void TestSechCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSechCplx" + "\"" + ">");
...
#region TestSechRealImag

public static void TestSechRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSechRealImag" + 
        "\"" + ">");
