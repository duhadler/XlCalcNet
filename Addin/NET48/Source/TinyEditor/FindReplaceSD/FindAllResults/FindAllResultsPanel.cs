namespace ScintillaNET_FindReplaceDialog.FindAllResults
{
    ...
    public partial class FindAllResultsPanel : UserControl
    {
        ...
        public FindAllResultsPanel()
        {
            ...
            // 
            FindResultsScintilla = new Scintilla();
            FindResultsScintilla.Dock = DockStyle.Fill;
            FindResultsScintilla.Location = new Point(0, 0);
            FindResultsScintilla.Name = "FindResultsScintilla";
            FindResultsScintilla.ScrollWidth = 5001;
            FindResultsScintilla.Size = new Size(556, 220);
            FindResultsScintilla.TabIndex = 4;
            FindResultsScintilla.Text = "FindResultsScintilla";
            FindResultsScintilla.UseTabs = false;
            FindResultsScintilla.KeyUp += new KeyEventHandler(FindResultsScintilla_KeyUp);
            FindResultsScintilla.MouseClick += new MouseEventHandler(FindResultsScintilla_MouseClick);
            FindResultsScintilla.MouseDoubleClick += new MouseEventHandler(FindResultsScintilla_MouseDoubleClick);
            
            InitializeComponent();
            
            Controls.Add(FindResultsScintilla);
