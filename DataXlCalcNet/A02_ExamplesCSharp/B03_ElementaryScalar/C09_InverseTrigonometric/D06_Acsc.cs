...
public static void TestAcscCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcscCplx" + "\"" + ">");
...
#region TestAcscRealImag

public static void TestAcscRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestAcscRealImag" + 
        "\"" + ">");
