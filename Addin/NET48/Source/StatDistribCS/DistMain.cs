...
namespace NewDistrib
{
    ...
    static class DistMain
    {
        ...
        {
            double LnGammaZPLusARet = default;
            var bb = new double[11];
            double lnz;
        ...
        public static void DemoEdgeworthClass()
        {
            Console.WriteLine("DemoEdgeworthClass()");
            double x = 20;
            double df = 10;

            int Order = 16;
            var kappa = new double[Order + 8];
            kappa[0] = 1;
            kappa[1] = df;
            ...
            double L1 = ecf.edgeworth(x, Order, kappa);
        ...
        public static void DemoMultivariate()
        {
            ...
            //DistN.DemoNoncentral();

            //// TEST BASED ON BETAPROD
            ////DistBoxDavis.NewTestWilksU();
            //DistBoxDavis.NewTestR0KSetsDis();
            //DistBoxDavis.NewTestR0DisX();
            //DistBoxDavis.NewTestMauchly();
            //DistBoxDavis.NewTestLvcDisX();
            //DistBoxDavis.NewTestLvcmDisX();
            //DistBoxDavis.NewTestEqualCovarianceMatricesSameSampleSize();


            //// TESTS BASED ON BOX-DAVIS
            //DistBoxDavis.Lvc0demo();
            //DistBoxDavis.Lvcmdemo();
            //DistBoxDavis.Bartlettdemo();
            //DistBoxDavis.NewBartlett_BoxDavis();

            //DistBoxDavis.EqualDistributions_Anderson();
            //DistBoxDavis.NewEqualDistributions_Anderson();

            //DistBoxDavis.EqualDistributions_Perlman();
            //DistBoxDavis.NewEqualDistributions_Perlman();
        ...
        public static void DemoDistMain()
        {
            //PermFriedman.MannWhitneyCalcdemo0();
            //PermFriedman.TerpstaCalcdemo0();
            //PermFriedman.KendallCalcdemo0();
            //PermFriedman.SignCalcdemo0();
            //PermFriedman.WilcoxonCalcdemo0();
            //PermFriedman.PageQCalcdemo0();
            //PermFriedman.PageCalcdemo0();
            //DistCornish.SpearmanCalcdemo0();
            //PermMilton.MiltonDemo();
            //PermFriedman.DemoFriedman();
            //PermKruskal.Kruskaldemo2();


            DistCornish.KendallInversCornishEdgeworthDemo();
            //DistCornish.ListNullCDFbyCumDemo();
