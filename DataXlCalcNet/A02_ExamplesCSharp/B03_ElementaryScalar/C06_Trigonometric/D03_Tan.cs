...
public static void TestTanCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestTanCplx" + "\"" + ">");
...
#region TestTanRealImag

public static void TestTanRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestTanRealImag" + 
        "\"" + ">");
