...
def funcplot2d(ctx, f, xlim=[-5,5], ylim=None, points=200, dpi=None, 
...
def Plot2dFloorCeilAbsSign(**kwargs): 
    funcplot2d(mpm, [mpm.floor, mpm.ceil, mpm.fabs, mpm.sign], [-5, 5], **kwargs)


try:
    if __name__ == '__main__':
        Plot2dFloorCeilAbsSign(Title = 'Plot2dFloorCeilAbsSign')
