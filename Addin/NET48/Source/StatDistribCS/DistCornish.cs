...
namespace NewDistrib
{
    ...
    static class DistCornish
    {
        ...
        public static void TerpstaCum(int k, int[] n, int maxmoment, ref double[] kappa, ref int TS)
        {
            var m = new int[k + 1];
            int j;
            // Dim TS As Integer
        ...
        public static void KendallCum(int n, int maxcum, ref double[] kappa, ref int nl)
        {
            // Praskova, 1976
            int j2;
        ...
        public static void WilcoxonCum(int n, int maxcum, ref double[] kappa, ref int nl)
        {
            // Fellingham, 1964
        ...
        public static void PageCum(int k, int n, int maxmoment, ref double[] kappa, ref int nl)
        {
            double[] X;
            var kl = default(int);
            int i;
        ...
        public static void KendallInversCornishEdgeworthDemo()
        {
            ...
            KendallCum(n, Order, ref kappa, ref nl);  // Kendall  
            ...
            //X = -610;  // Order_i: 30, LeftTail: 3,67769760607587E-17, RefDiff: -4,05814660955765E-05
            X = -310;  // Order_i: 32, LeftTail: 0,000101656163196239, RefDiff: 7,87905356389875E-14
            ...
            RightTail = 1d - LeftTail;
            Console.WriteLine("Plain Normal LeftTail {0}, RightTail: {1}", LeftTail, RightTail);

            int xpos = Convert.ToInt32(X + nl) / 2;
            double ExactResult = CDF_KR[xpos - 1];
            Console.WriteLine("X :{0};  ExactResult LeftTail: {1}", X, ExactResult);

            Console.WriteLine("Start InvCorn");
            ...
            Console.WriteLine("Stop InvCorn");
        ...
        public static void ListNullCDFbyCumDemo()
        {
            ...
            //double X;
            //double RightTail;
            //int Index; // , index2 As Integer
            //bool OnlyEvenCumulants;
            //double LeftTail0;
            //double LeftTail2;
            ...
            //bool OnlyEvenCumulants = false;
            dis = 1;
            maxmoment = 12;
            var o = new double[maxmoment + 1];
            ...
            switch (dis)
            {
                case 1:
                    {
                        TerpstaCum(k, n, maxmoment, ref kappa, ref nl); // Terpsta
                        break;
                    }
                case 2:
                    {
                        TerpstaCum(2, n, maxmoment, ref kappa, ref nl); // Mann-Whitney
                        break;
                    }
                case 3:
                    {
                        WilcoxonCum(n[1], maxmoment, ref kappa, ref nl); // Wilcoxon
                        break;
                    }
                case 4:
                    {
                        KendallCum(n[1], maxmoment, ref kappa, ref nl);  // Kendall
                        break;
                    }
                // Case 5: Call SpearmanCum(n, maxmoment, kappa, nl) 'Spearman
                case 6:
                    {
                        PageCum(k, n[1], maxmoment, ref kappa, ref nl); // Page
                        break;
                    }
            }
            // Exit Sub
            ...
            //double[] KR = PermFriedman.KendallCalc(n[1]);
            ...
            //sigma = Math.Sqrt(kappa[2]);
            //CumulantToGamma(maxmoment, 0d, ref sigma, ref kappa, ref o);

            //if (OnlyEvenCumulants)
            //{
            ...
            //var CDF_KR = new double[nl + 1 + 1];
            //var loopTo3 = nl;
            //for (Index = -nl; Index <= loopTo3; Index += 2)
            //{
            //    sumKR = sumKR + KR[i];
            //    CDF_KR[i] = sumKR;
            //    i = i + 1;
            ...
            //sumKR = 0.0d;
            //i = 0;
            //for (Index = -100; Index <= 100; Index += 2)
            //{
            //    // For Index = -nl To nl Step 2

            //    // X = (Index - mu + 0.5) / sigma
            //    X = (Index - mu + 1.0d) / sigma;

            //    CalcEdgeworth(true, OnlyEvenCumulants, 0, maxmoment, X, ref o, ref LeftTail0, ref RightTail);
            //    CalcEdgeworth(true, OnlyEvenCumulants, 0, 0, X, ref o, ref LeftTail2, ref RightTail);
            ...
            //    Console.WriteLine("i: {0}, s: {1}, L0: {2}, L2: {3}, L2: {4}, L2: {5}, D2: {6}", 1d * (Index - mu), sumKR, LeftTail0, LeftTail2, (LeftTail0 - sumKR) / sumKR, (LeftTail2 - sumKR) / sumKR, (LeftTail2 - sumKR) / (LeftTail0 - sumKR));
