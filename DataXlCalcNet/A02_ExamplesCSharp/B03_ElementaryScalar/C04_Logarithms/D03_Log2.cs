...
public static void TestLog2Cplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLog2Cplx" + "\"" + ">");
...
#region TestLog2RealImag

public static void TestLog2RealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestLog2RealImag" + 
        "\"" + ">");
