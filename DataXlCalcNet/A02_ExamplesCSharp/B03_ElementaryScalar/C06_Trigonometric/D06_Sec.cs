...
public static void TestSecCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSecCplx" + "\"" + ">");
...
#region TestSecRealImag

public static void TestSecRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestSecRealImag" + 
        "\"" + ">");
