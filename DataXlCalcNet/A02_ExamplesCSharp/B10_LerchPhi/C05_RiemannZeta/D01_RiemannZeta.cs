...
/* No syntax highlighting if HasArbPrecNet is undefined */
    ...
    TestRiemannZetaReal();
    TestRiemannZetaCplx();
    TestRiemannZetaRealImag();
}


#region TestRiemannZetaReal

public static void TestRiemannZetaReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestRiemannZetaReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var s in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "zeta(s); " + "s={0}" 
            + "\"" + ">", s);
        Double res01 = math53.zeta(s);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.zeta(s);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.zeta(s);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.zeta(s);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.zeta(s);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.zeta(s);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.zeta(s);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.zeta(s);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.zeta(s);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.zeta(s);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.zeta(s);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.zeta(s);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.zeta(s);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.zeta(s);
...
#region TestRiemannZetaCplx

public static void TestRiemannZetaCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestRiemannZetaCplx" + "\"" + ">");
...
#region TestRiemannZetaRealImag

public static void TestRiemannZetaRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestRiemannZetaRealImag" + 
        "\"" + ">");
