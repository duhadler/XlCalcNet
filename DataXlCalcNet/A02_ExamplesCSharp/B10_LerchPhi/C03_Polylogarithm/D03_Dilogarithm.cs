...
#region TestDilogReal

public static void TestDilogReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestDilogReal" + "\"" + ">");
    double[] InputArray1 = { -0.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "dilog(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.dilog(x);
        Console.WriteLine("math53:  {0}", res01);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Single res08 = sflint.dilog(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.dilog(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.dilog(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.dilog(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.dilog(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.dilog(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.dilog(x);
...
#region TestDilogCplx

public static void TestDilogCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestDilogCplx" + "\"" + ">");
    Complex[] InputArray1C = { dcplx.t(-4.333d, 2), dcplx.t(0.0d, 2), 
        dcplx.t(4.333d, 2) };
    foreach (var x in InputArray1C) {
        Console.WriteLine("<H2 Title=" + "\"" + "dilog(x); " + "x={0}" + 
            "\"" + ">", x);
        Complex res01 = cmath53.dilog(x);
        Console.WriteLine("cmath53:  {0}", res01);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        SingleC res08 = sflintc.dilog(x);
        Console.WriteLine("sflintc:  {0}", res08);
        Complex res09 = dflintc.dilog(x);
        Console.WriteLine("dflintc:  {0}", res09);
        ExtendedC res10 = eflintc.dilog(x);
        Console.WriteLine("eflintc:  {0}", res10);
        QuadrupleC res11 = qflintc.dilog(x);
        Console.WriteLine("qflintc:  {0}", res11);
        OctupleC res12 = oflintc.dilog(x);
        Console.WriteLine("oflintc:  {0}", res12);
        MpfrC res13 = mflintc.dilog(x);
        Console.WriteLine("mflintc:  {0}", res13);
        ArbC res16 = aflintc.dilog(x);
...
#region TestDilogRealImag

public static void TestDilogRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestDilogRealImag" + 
        "\"" + ">");
