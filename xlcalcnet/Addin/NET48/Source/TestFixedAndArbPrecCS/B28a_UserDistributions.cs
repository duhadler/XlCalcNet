...
namespace TestXlCalcNetPrecCS
{
    ...
    static partial class Tests
    {
        ...
        public static void MannWhitneyPmfVectorDemo()
        {
            int m = 10;
            int n = 10;
            double[] X = MannWhitneyPmfVector(m, n);
        ...
        public static void SpearmanPmfVectorDemo()
        {
            ...
            double[] pmfvec = SpearmanPmfVector(n);
        ...
        public static void SignTestPmfVectorDemo()
        {
            ...
            double[] pmfvec = SignTestPmfVector(N);
            for (int i = 0; i < pmfvec.Length; i++)
            {
                Console.WriteLine("i: {0}, pmf[i]:{1}", i, pmfvec[i]);
            }
        ...
        public static void WilcoxonPmfVectorDemo()
        {
            ...
            double[] pmfvec = WilcoxonPmfVector(N);
            for (int i = 0; i < pmfvec.Length; i++)
            {
                Console.WriteLine("i: {0}, pmf[i]:{1}", i, pmfvec[i]);
            }
        ...
        public static void PagePmfVectorDemo()
        {
            ...
            double[] pmfvec = PagePmfVector(k, N);
            for (int i = 0; i < pmfvec.Length; i++)
            {
                Console.WriteLine("i: {0}, pmf[i]:{1}", i, pmfvec[i]);
            }
        ...
        public static void PageQuadePmfVectorDemo()
        {
            ...
            double[] pmfvec = PageQuadePmfVector(k, N);
            for (int i = 0; i < pmfvec.Length; i++)
            {
                Console.WriteLine("i: {0}, pmf[i]:{1}", i, pmfvec[i]);
            }
        ...
        public static void DemoFriedman()
        {
            ...
            double[,] Output = Friedman(k, n, Quade, Mode, Mode2);
        ...
        public static void RunTestsRankDistributions()
        {
            Console.WriteLine("Hello RunTestsRankDistributions");
        ...
        public static void RankDistributions()
        {
            var stopWatch = new Stopwatch();
            stopWatch.Start();

            RunTestsRankDistributions();
