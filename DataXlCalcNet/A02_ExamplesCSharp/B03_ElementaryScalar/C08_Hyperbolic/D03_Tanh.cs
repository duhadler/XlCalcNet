...
public static void TestTanhCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestTanhCplx" + "\"" + ">");
...
#region TestTanhRealImag

public static void TestTanhRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestTanhRealImag" + 
        "\"" + ">");
