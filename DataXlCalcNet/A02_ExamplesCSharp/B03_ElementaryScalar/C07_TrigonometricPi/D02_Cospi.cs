...
#region TestCospiReal

public static void TestCospiReal()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCospiReal" + "\"" + ">");
    double[] InputArray1 = { -4.333, 0.0, 4.333 };
    
    foreach (var x in InputArray1) {
        Console.WriteLine("<H2 Title=" + "\"" + "cospi(x); " + "x={0}" 
            + "\"" + ">", x);
        Double res01 = math53.cospi(x);
        Console.WriteLine("math53:  {0}", res01);
        Single res02 = sreal.cospi(x);
        Console.WriteLine(" sreal:  {0}", res02);
        Double res03 = dreal.cospi(x);
        Console.WriteLine(" dreal:  {0}", res03);
        Extended res04 = ereal.cospi(x);
        Console.WriteLine(" ereal:  {0}", res04);
        Quadruple res05 = qreal.cospi(x);
        Console.WriteLine(" qreal:  {0}", res05);
        Octuple res06 = oreal.cospi(x);
        Console.WriteLine(" oreal:  {0}", res06);
#if HasArbPrecNet
/* No syntax highlighting if HasArbPrecNet is undefined */
        Mpfr res07 = mreal.cospi(x);
        Console.WriteLine(" mreal:  {0}", res07);
        Single res08 = sflint.cospi(x);
        Console.WriteLine("sflint:  {0}", res08);
        Double res09 = dflint.cospi(x);
        Console.WriteLine("dflint:  {0}", res09);
        Extended res10 = eflint.cospi(x);
        Console.WriteLine("eflint:  {0}", res10);
        Quadruple res11 = qflint.cospi(x);
        Console.WriteLine("qflint:  {0}", res11);
        Octuple res12 = oflint.cospi(x);
        Console.WriteLine("oflint:  {0}", res12);
        Mpfr res13 = mflint.cospi(x);
        Console.WriteLine("mflint:  {0}", res13);
        Arb res16 = aflint.cospi(x);
...
#region TestCospiCplx

public static void TestCospiCplx()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCospiCplx" + "\"" + ">");
...
#region TestCospiRealImag

public static void TestCospiRealImag()
{
    Console.WriteLine("<H1 Title=" + "\"" + "TestCospiRealImag" + 
        "\"" + ">");
